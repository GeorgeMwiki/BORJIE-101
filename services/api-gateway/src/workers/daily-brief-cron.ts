...
async function composeMwikilaGreeting(
  ...
  const summary = JSON.stringify({
    ...
    cashOnHandTzs: args.brief.cashRunway.cashOnHandTzs,
    netDailyBurnTzs: args.brief.cashRunway.netDailyBurnTzs,
    cashRunwayDays: args.brief.cashRunway.runwayDays,
    cashBurnStatus: args.brief.cashRunway.burnStatus,
