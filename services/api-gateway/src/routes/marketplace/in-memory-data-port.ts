...
const ORGS: ReadonlyArray<OrgProfile> = [
  {
    ...
    description: 'Family-run portfolio of 12 small-scale mining sites in Nairobi.',
    city: 'Nairobi',
    country: 'KE',
    listingCount: 2,
    tenderCount: 1,
  ...
  },
  {
    ...
    name: 'Kilimani Homes',
    slug: 'kilimani-homes',
    description: 'Mid-market mining sites and tenders across coastal Kenya.',
    city: 'Mombasa',
    country: 'KE',
    listingCount: 1,
    tenderCount: 1,
    ...
    joinCodePromptHint: 'Your estate operator will share a code on signing.',
  },
];
