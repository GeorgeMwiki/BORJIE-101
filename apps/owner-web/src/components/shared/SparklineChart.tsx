 ...
 *
 * Recharts (~5 MB) is isolated in this module so it can be code-split
 * out of the initial/SSR bundle — consumers import the lazy `Sparkline`
 * wrapper (./Sparkline), never this file directly.
 */
