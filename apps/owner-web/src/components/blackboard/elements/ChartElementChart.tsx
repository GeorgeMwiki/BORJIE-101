...
/**
 * ChartElementChart — bar (recharts impl; lazy-loaded via ./ChartElement) / line / donut renderer over recharts.
 *
...
export function ChartElementChart({ payload, languagePreference }: ChartElementProps): ReactElement {
