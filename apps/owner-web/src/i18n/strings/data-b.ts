...
export const dataBStrings = {
  ...
  mktMetricCounterLabel: { sw: 'Majibu pinzani', en: 'Counter offers' },
  mktMetricCounterSub: { sw: 'Zinahitaji uamuzi wako', en: 'Need your call' },
  mktMetricAvgLabel: { sw: 'Wastani wa bei', en: 'Average offer' },
  mktMetricAvgSub: { sw: 'Kwa parcel leo', en: 'Per parcel today' },
  mktPriceOnRequest: { sw: 'Bei kwa ombi', en: 'Price on request' },
  mktLoadError: {
  ...
  mktOutboundTitle: { sw: 'Mauzo ya nje', en: 'Outbound (sell)' },
  mktOutboundSubtitle: {
