...
/**
 * O-W-14-PACK — Monthly compliance pack surface (client).
 *
...
interface CompliancePackSurfaceProps {
  readonly initialLocale?: Locale;
}

export function CompliancePackSurface({ initialLocale }: CompliancePackSurfaceProps) {
