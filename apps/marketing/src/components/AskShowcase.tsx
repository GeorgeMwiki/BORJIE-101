    ...
    >
      ...
      <article className="mx-auto mt-14 flex max-w-3xl flex-col gap-5 rounded-2xl border border-border bg-surface p-6 shadow-sm sm:p-8">
        <header className="flex items-start justify-between gap-4">
          <div>
            <p className="inline-flex items-center gap-1.5 font-mono text-caption uppercase tracking-widest text-signal-500">
          ...
          <span className="rounded-full border border-border px-2 py-0.5 font-mono text-caption text-neutral-400">
            on-chain
          </span>
        </header>
        ...
        <div className="rounded-xl border border-border bg-background p-4">
          ...
          <p className="mt-1 text-body-md font-medium text-foreground">{t.question}</p>
        </div>
          ...
          <ol className="mt-2 space-y-1">
            {t.answerPlan.map((step, i) => (
              <li key={i} className="flex items-start gap-2 text-body-sm text-foreground">
                <span className="mt-0.5 font-mono text-micro-num text-signal-500 tabular-nums">
        ...
        <div>
          ...
          <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-signal-500/30 bg-signal-500/5 px-3 py-1.5">
            ...
            <span className="font-mono text-caption uppercase tracking-widest text-signal-500">
              {t.evidence}
            </span>
          </div>
        </div>
