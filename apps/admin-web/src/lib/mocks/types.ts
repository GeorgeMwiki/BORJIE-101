/**
 * Borjie Console mock data — shared TypeScript shapes.
 *
 * Every type mirrors what the api-gateway will eventually return for
 * `/api/v1/internal/*`. Keep this file generic — domain values (e.g.
 * Tanzanian regulator names, mineral commodities) live in the
 * per-screen mock fixtures.
 */
