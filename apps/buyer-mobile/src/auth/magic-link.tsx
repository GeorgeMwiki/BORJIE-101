/**
 * Magic-link mobile login for Borjie Buyers — Wave MAGIC-LINK-LOGIN.
 *
 * Mirror of the workforce-mobile flow with buyer-specific copy and
 * the `borjie-buyer://auth-callback` scheme handler. Supabase OTP
...
const COPY: Record<Locale, {
  ...
  en: {
    title: 'Sign in to Borjie Buyers',
...
function callbackUrl(): string {
  // Linking.createURL builds `borjie-buyer://auth-callback` from the
  // configured Expo scheme (app.json → expo.scheme = "borjie-buyer").
