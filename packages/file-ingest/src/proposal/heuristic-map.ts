...
const SYNONYMS: ReadonlyMap<string, ReadonlyArray<string>> = new Map([
  ['full_name', ['fullname', 'name', 'employeename', 'buyername', 'counterpartyname', 'customername']],
  ...
  ['stage', ['stage', 'pipelinestage', 'buyerstage', 'status']],
  ['budget', ['budget', 'estimatedbudget', 'spendingrange']],
  ['notes', ['notes', 'comment', 'comments', 'remark', 'remarks']],
  ['reference', ['reference', 'ref', 'code', 'id', 'assetref', 'assetid', 'sku']],
  ['location', ['location', 'streetaddress', 'address', 'fulllocation', 'sitelocation']],
  ['region', ['region', 'zone', 'district', 'town', 'municipality']],
  ['pit_count', ['pitcount', 'pits', 'numberofpits', 'totalpits']],
  ['monthly_royalty', ['monthlyroyalty', 'royalty', 'royaltyamount', 'royaltytzs']],
  ['valuation', ['valuation', 'value', 'marketvalue', 'appraisedvalue']],
  ['site_manager', ['sitemanager', 'manager', 'assignedmanager']],
  ...
  ['tin', ['tin', 'taxid', 'taxnumber', 'trapin', 'taxpin']],
  ['rating', ['rating', 'score', 'vendorrating']],
  ['counterparty_ref', ['counterpartyref', 'counterpartyid', 'counterparty', 'counterpartycode']],
  ...
  ['offtake_ref', ['offtakeref', 'offtakeid', 'offtakecode', 'agreementref', 'contractref']],
  ['counterparty_name', ['counterpartyname']],
  ['asset_ref', ['assetref', 'assetid', 'assetcode']],
  ['end_date', ['enddate', 'expirydate', 'agreementend']],
