...
const DEFAULT_ENTITY_TYPES: ReadonlyArray<EntityTypeDescriptor> = Object.freeze([
  ...
  Object.freeze({
    ...
    required_attribute_keys: Object.freeze(['reference', 'location']),
  }),
  Object.freeze({
    entity_type: 'vendor',
    label: 'Vendor',
  ...
  Object.freeze({
    ...
    required_attribute_keys: Object.freeze(['counterparty_ref', 'amount', 'paid_at']),
  }),
  Object.freeze({
    entity_type: 'tra_filing',
    label: 'TRA filing',
    attribute_keys: Object.freeze([
      'tin',
      'period',
    ...
    required_attribute_keys: Object.freeze(['tin', 'period', 'filing_type']),
  }),
  Object.freeze({
    entity_type: 'offtake_agreement',
    ...
    required_attribute_keys: Object.freeze(['offtake_ref', 'counterparty_name', 'asset_ref']),
  }),
  Object.freeze({
