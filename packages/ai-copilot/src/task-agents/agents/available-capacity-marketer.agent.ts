 ...
 * available capacity pipeline subscribes to.
 *
...
export const availableCapacityMarketerAgent: TaskAgent<typeof PayloadSchema> = {
  id: 'available_capacity_marketer_agent',
  title: 'Available-Capacity Marketer',
  description:
