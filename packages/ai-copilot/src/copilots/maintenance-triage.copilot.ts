  ...
  protected parseAIResponse(
    ...
    const output: MaintenanceTriageOutput = {
      ...
      triage: {
        ...
        category,
        ...(aiResponse.triage.subcategory !== undefined ? { subcategory: aiResponse.triage.subcategory } : {}),
      ...
      routing: {
        ...
        ...(aiResponse.routing.suggestedVendorIds !== undefined ? { suggestedVendorIds: aiResponse.routing.suggestedVendorIds } : {}),
        ...
        suggestedScheduling: {
          ...
          ...(aiResponse.routing.suggestedScheduling.preferredTimeOfDay !== undefined ? { preferredTimeOfDay: aiResponse.routing.suggestedScheduling.preferredTimeOfDay as 'morning' | 'afternoon' | 'evening' | 'any' } : {}),
        },
      },
