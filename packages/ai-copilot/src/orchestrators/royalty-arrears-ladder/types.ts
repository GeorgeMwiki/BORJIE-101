/**
 * RoyaltyArrearsLadderOrchestrator — types + ports.
 *
 * Wave 28 AGENT ORCHESTRATE.
 *
 * Each counterparty outstanding-royalties case walks a ladder of increasingly firm
 * reminders. If the counterparty pays between steps the orchestrator pivots to
...
export const ROYALTY_ARREARS_LADDER_STEPS = [
  'soft_reminder',
  'firm_reminder',
  'final_notice',
  'case_escalation',
...
export type Step = (typeof ROYALTY_ARREARS_LADDER_STEPS)[number];
...
export interface RoyaltyArrearsLadderOrchestratorDeps {
