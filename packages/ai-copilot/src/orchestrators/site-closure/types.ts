/**
 * SiteClosureOrchestrator — types + ports.
 *
...
export const SITE_CLOSURE_STEPS = [
  'notice_received',
...
export type Step = (typeof SITE_CLOSURE_STEPS)[number];
...
export interface RunStorePort {
  ...
  findRunByOfftake(tenantId: string, offtakeId: string): Promise<RunState | null>;
...
export interface SiteClosureOrchestratorDeps {
