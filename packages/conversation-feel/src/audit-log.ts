 ...
 * tamper-evident, matching Borjie's append-only AI-audit-chain invariant.
 *
 * References:
...
import type { GuardIntervention, SessionStats } from './types.js';
...
function bodyOf(rec: Omit<GuardIntervention, 'hash_self' | 'hash_prev'>): string {
