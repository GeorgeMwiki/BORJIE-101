 ...
 * members per shift, sees the Mining Shift Specialist's skill-match
 * recommendations, and commits to the roster. Used both at the start
 * of a shift and when a crew change happens mid-shift.
 *
