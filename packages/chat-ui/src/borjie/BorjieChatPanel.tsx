...
export const BORJIE_BRAND_SW = 'Borjie · Afisa wa AI wa Shughuli za Madini';
...
export const BORJIE_INTRO_SW =
  'Habari, mimi ni Bw. Mwikila, Afisa wa AI wa Shughuli za Madini wa Borjie. Ninaendesha biashara yako ya mgodi mwanzo hadi mwisho. Niulize kuhusu migodi yako, leseni, vifurushi vya madini, hatari ya kubadilisha sarafu, au lolote katika kanzi ya uchimbaji madini.';
