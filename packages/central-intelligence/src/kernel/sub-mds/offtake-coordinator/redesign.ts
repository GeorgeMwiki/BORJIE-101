/**
 * REDESIGN — LLM proposes offtake renewal-cycle improvements (earlier
...
const SYSTEM_PROMPT = [
  'You are the Borjie OfftakeCoordinator sub-MD in REDESIGN mode.',
  ...
  'delivery gap. Propose 1-3 reversible steps. Output strict JSON.',
].join('\n');
