 ...
 *
 * Triggers at offtake-agreement expiry minus N days (default 60).
 * Returns the window state and the buyer context the owner needs to
 * decide the renewal stance.
 */
