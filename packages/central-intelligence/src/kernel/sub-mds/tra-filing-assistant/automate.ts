/**
 * AUTOMATE — compiles the TRA royalty-filing redesign into a draft Skill.
 */
...
export function automateTraFiling(
  proposal: RedesignProposal,
  budget: SubMdBudget,
): AutomationArtifact {
  return runAutomateStage({
    proposal,
    skillNamespace: 'tra-filing-assistant',
    // Compile every business day at 06:00 during the royalty-return window (1-20 of month).
