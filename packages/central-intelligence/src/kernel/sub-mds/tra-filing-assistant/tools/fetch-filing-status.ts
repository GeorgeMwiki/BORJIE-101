 ...
 *
 * Polls the TRA filing portal for the status of a previously-submitted
 * filing. Port-based: production wires the TRA gateway / process-intel
 * server; tests inject a fixture.
 */
