...
export function citeEvidence(args: CiteEvidenceArgs): CiteEvidenceResult {
  ...
  const items: Citation[] = [
    ...
    citation('cashflow.arrears', 'cashflow', s.cashflow.citation, 'outstanding royalties balance'),
    citation('occupancy.rate', 'occupancy', s.occupancy.citation, 'asset utilization rate'),
    citation('occupancy.signs', 'occupancy', s.occupancy.citation, 'new offtake signs this week'),
    citation('arrears.newThisWeek', 'arrears', s.arrears.citation, 'new outstanding-royalty cases this week'),
