 ...
 * file a royalty", the payment section MUST be top of the layout — no
 ...
 * sections (e.g. "payment" matches both "owner.payments.history"
 * and "owner.payments.new"). The policy pins ALL matches, in base
 ...
 * key directly. A new "owner.payment-plans" section will be picked
 * up automatically by the "payment" intent.
 */
const INTENT_MARKERS: Readonly<Record<string, readonly string[]>> = Object.freeze({
  payment: Object.freeze(['payment', 'paid', 'pay-royalty', 'invoice']),
  payments: Object.freeze(['payment', 'paid', 'pay-royalty', 'invoice']),
  royalty: Object.freeze(['payment', 'paid', 'pay-royalty', 'royalty']),
  ...
  compliance: Object.freeze(['compliance', 'filing', 'tra', 'gepg']),
  offtake: Object.freeze(['offtake', 'agreement', 'contract', 'supply']),
});
