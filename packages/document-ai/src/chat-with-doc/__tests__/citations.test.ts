...
describe('parseAnswerWithCitations', () => {
  it('extracts and de-duplicates citations and rewrites with numbered refs', () => {
    const raw =
      'The royalty is TZS 1,250,000 [doc:d1#p1:b-3:"Monthly Royalty: TZS 1,250,000"] and due monthly [doc:d1#p1:b-3:"Monthly Royalty: TZS 1,250,000"].';
