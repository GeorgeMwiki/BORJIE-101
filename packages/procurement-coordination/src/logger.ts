/**
 * Structured logger for @borjie/procurement-coordination.
 *
 ...
 * Replaces direct `console.*` calls per `.semgrep/borjie-rules.yml` rule
...
const pinoLogger = pino({
  ...
  base: { service: '@borjie/procurement-coordination' },
  redact: {
