/**
 * Boundary PII redactor for email subjects + bodies + addresses.
 *
 * Same salted-sha256 scheme as session-mirror; the email connector
 * also exposes `redactAddress` to canonicalise `from_addr` / `to_addrs`
 * into salted hashes before persistence.
 */
