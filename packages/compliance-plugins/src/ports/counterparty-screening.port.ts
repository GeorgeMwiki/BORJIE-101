/**
 * CounterpartyScreeningPort — external credit-bureau adapter.
 *
 ...
 * for US/UK, Schufa for Germany), that call is abstracted here. It screens a
 * mining counterparty — a buyer, off-taker, or sub-supply operator — before
 * an offtake / supply agreement is signed.
 *
...
export interface CounterpartyScreeningPort {
  /**
...
export const DEFAULT_COUNTERPARTY_SCREENING: CounterpartyScreeningPort = {
