/**
 * Oman (OM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../om/index.ts`,
...
const omanCore: CountryPlugin = {
  countryCode: 'OM',
  countryName: 'Oman',
  currencyCode: 'OMR',
  currencySymbol: 'ر.ع.',
  phoneCountryCode: '968',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '968', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const omanScaffoldProfile: ExtendedCountryProfile = {
  plugin: omanCore,
  languages: ['ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'OM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Oman has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const omanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../om/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
