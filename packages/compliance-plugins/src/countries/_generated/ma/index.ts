/**
 * Morocco (MA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ma/index.ts`,
...
const moroccoCore: CountryPlugin = {
  countryCode: 'MA',
  countryName: 'Morocco',
  currencyCode: 'MAD',
  currencySymbol: 'د.م.',
...
export const moroccoScaffoldProfile: ExtendedCountryProfile = {
  plugin: moroccoCore,
  languages: ['ar', 'fr'],
  ...
  taxRegime: stubWithholding(
    'MA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Morocco has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const moroccoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ma/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
