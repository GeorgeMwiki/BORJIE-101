/**
 * Palestine, State of (PS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ps/index.ts`,
...
const palestineStateOfCore: CountryPlugin = {
  countryCode: 'PS',
  countryName: 'Palestine, State of',
  currencyCode: 'ILS',
  currencySymbol: '₪',
  phoneCountryCode: '970',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '970', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const palestineStateOfScaffoldProfile: ExtendedCountryProfile = {
  plugin: palestineStateOfCore,
  languages: ['ar'],
  ...
  taxRegime: stubWithholding(
    'PS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Palestine, State of has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const palestineStateOfScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ps/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
