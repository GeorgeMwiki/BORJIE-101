/**
 * Tunisia (TN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tn/index.ts`,
...
const tunisiaCore: CountryPlugin = {
  countryCode: 'TN',
  countryName: 'Tunisia',
  currencyCode: 'TND',
  currencySymbol: 'د.ت',
  phoneCountryCode: '216',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '216', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const tunisiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: tunisiaCore,
  languages: ['ar', 'fr'],
  ...
  taxRegime: stubWithholding(
    'TN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tunisia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tunisiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
