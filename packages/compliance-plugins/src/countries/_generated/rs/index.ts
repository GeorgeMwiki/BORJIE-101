/**
 * Serbia (RS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../rs/index.ts`,
...
const serbiaCore: CountryPlugin = {
  countryCode: 'RS',
  countryName: 'Serbia',
  currencyCode: 'RSD',
  currencySymbol: 'дин.',
  phoneCountryCode: '381',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '381', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const serbiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: serbiaCore,
  languages: ['sr'],
  ...
  taxRegime: stubWithholding(
    'RS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Serbia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const serbiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../rs/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
