/**
 * Finland (FI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../fi/index.ts`,
...
const finlandCore: CountryPlugin = {
  countryCode: 'FI',
  countryName: 'Finland',
  currencyCode: 'EUR',
  currencySymbol: '€',
...
export const finlandScaffoldProfile: ExtendedCountryProfile = {
  plugin: finlandCore,
  languages: ['fi', 'sv', 'en'],
  ...
  taxRegime: stubWithholding(
    'FI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Finland has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const finlandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fi/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
