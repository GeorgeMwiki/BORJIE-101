/**
 * South Georgia and the South Sandwich Islands (GS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gs/index.ts`,
...
const southGeorgiaAndTheSouthSandwichIslandsCore: CountryPlugin = {
  countryCode: 'GS',
  countryName: 'South Georgia and the South Sandwich Islands',
  currencyCode: 'GBP',
  currencySymbol: '£',
  phoneCountryCode: '500',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '500', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const southGeorgiaAndTheSouthSandwichIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: southGeorgiaAndTheSouthSandwichIslandsCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'GS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: South Georgia and the South Sandwich Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const southGeorgiaAndTheSouthSandwichIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gs/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
