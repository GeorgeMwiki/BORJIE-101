/**
 * Bouvet Island (BV) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bv/index.ts`,
...
const bouvetIslandCore: CountryPlugin = {
  countryCode: 'BV',
...
export const bouvetIslandScaffoldProfile: ExtendedCountryProfile = {
  plugin: bouvetIslandCore,
  languages: ['no'],
  ...
  taxRegime: stubWithholding(
    'BV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bouvet Island has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bouvetIslandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bv/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
