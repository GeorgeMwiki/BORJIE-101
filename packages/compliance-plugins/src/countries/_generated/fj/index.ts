/**
 * Fiji (FJ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../fj/index.ts`,
...
const fijiCore: CountryPlugin = {
  countryCode: 'FJ',
  countryName: 'Fiji',
  currencyCode: 'FJD',
  currencySymbol: '$',
  phoneCountryCode: '679',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '679', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const fijiScaffoldProfile: ExtendedCountryProfile = {
  plugin: fijiCore,
  languages: ['en', 'fj'],
  ...
  taxRegime: stubWithholding(
    'FJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Fiji has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const fijiScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fj/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
