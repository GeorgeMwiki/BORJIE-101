/**
 * Egypt (EG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../eg/index.ts`,
...
const egyptCore: CountryPlugin = {
  countryCode: 'EG',
  countryName: 'Egypt',
  currencyCode: 'EGP',
  currencySymbol: 'ج.م',
  phoneCountryCode: '20',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '20', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const egyptScaffoldProfile: ExtendedCountryProfile = {
  plugin: egyptCore,
  languages: ['ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'EG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Egypt has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const egyptScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../eg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
