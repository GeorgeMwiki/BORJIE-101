/**
 * Yemen (YE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ye/index.ts`,
...
const yemenCore: CountryPlugin = {
  countryCode: 'YE',
  countryName: 'Yemen',
  currencyCode: 'YER',
  currencySymbol: '﷼',
  phoneCountryCode: '967',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '967', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const yemenScaffoldProfile: ExtendedCountryProfile = {
  plugin: yemenCore,
  languages: ['ar'],
  ...
  taxRegime: stubWithholding(
    'YE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Yemen has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const yemenScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ye/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
