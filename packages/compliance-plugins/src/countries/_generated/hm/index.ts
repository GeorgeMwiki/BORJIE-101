/**
 * Heard Island and McDonald Islands (HM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../hm/index.ts`,
...
const heardIslandAndMcdonaldIslandsCore: CountryPlugin = {
  countryCode: 'HM',
...
export const heardIslandAndMcdonaldIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: heardIslandAndMcdonaldIslandsCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'HM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Heard Island and McDonald Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const heardIslandAndMcdonaldIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
