/**
 * Monaco (MC) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mc/index.ts`,
...
const monacoCore: CountryPlugin = {
  countryCode: 'MC',
  countryName: 'Monaco',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '377',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '377', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const monacoScaffoldProfile: ExtendedCountryProfile = {
  plugin: monacoCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'MC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Monaco has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const monacoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mc/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
