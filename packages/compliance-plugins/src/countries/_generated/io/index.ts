/**
 * British Indian Ocean Territory (IO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../io/index.ts`,
...
const britishIndianOceanTerritoryCore: CountryPlugin = {
  countryCode: 'IO',
  countryName: 'British Indian Ocean Territory',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '246',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '246', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const britishIndianOceanTerritoryScaffoldProfile: ExtendedCountryProfile = {
  plugin: britishIndianOceanTerritoryCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'IO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: British Indian Ocean Territory has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const britishIndianOceanTerritoryScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../io/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
