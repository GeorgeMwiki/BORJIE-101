/**
 * Cayman Islands (KY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ky/index.ts`,
...
const caymanIslandsCore: CountryPlugin = {
  countryCode: 'KY',
  countryName: 'Cayman Islands',
  currencyCode: 'KYD',
  currencySymbol: '$',
  phoneCountryCode: '1345',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1345', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const caymanIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: caymanIslandsCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'KY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cayman Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const caymanIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ky/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
