/**
 * Sierra Leone (SL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sl/index.ts`,
...
const sierraLeoneCore: CountryPlugin = {
  countryCode: 'SL',
  countryName: 'Sierra Leone',
  currencyCode: 'SLE',
  currencySymbol: 'Le',
  phoneCountryCode: '232',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '232', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const sierraLeoneScaffoldProfile: ExtendedCountryProfile = {
  plugin: sierraLeoneCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'SL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sierra Leone has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sierraLeoneScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sl/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
