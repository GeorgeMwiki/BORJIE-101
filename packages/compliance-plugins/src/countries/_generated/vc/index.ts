/**
 * Saint Vincent and the Grenadines (VC) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../vc/index.ts`,
...
const saintVincentAndTheGrenadinesCore: CountryPlugin = {
  countryCode: 'VC',
  countryName: 'Saint Vincent and the Grenadines',
  currencyCode: 'XCD',
  currencySymbol: '$',
  phoneCountryCode: '1784',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1784', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const saintVincentAndTheGrenadinesScaffoldProfile: ExtendedCountryProfile = {
  plugin: saintVincentAndTheGrenadinesCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'VC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Vincent and the Grenadines has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintVincentAndTheGrenadinesScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vc/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
