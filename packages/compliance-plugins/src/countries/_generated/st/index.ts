/**
 * Sao Tome and Principe (ST) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../st/index.ts`,
...
const saoTomeAndPrincipeCore: CountryPlugin = {
  countryCode: 'ST',
  countryName: 'Sao Tome and Principe',
  currencyCode: 'STN',
  currencySymbol: 'Db',
  phoneCountryCode: '239',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '239', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const saoTomeAndPrincipeScaffoldProfile: ExtendedCountryProfile = {
  plugin: saoTomeAndPrincipeCore,
  languages: ['pt'],
  ...
  taxRegime: stubWithholding(
    'ST-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sao Tome and Principe has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saoTomeAndPrincipeScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../st/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
