/**
 * Mayotte (YT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../yt/index.ts`,
...
const mayotteCore: CountryPlugin = {
  countryCode: 'YT',
  countryName: 'Mayotte',
  currencyCode: 'EUR',
  currencySymbol: '€',
...
export const mayotteScaffoldProfile: ExtendedCountryProfile = {
  plugin: mayotteCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'YT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mayotte has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mayotteScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../yt/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
