/**
 * Eritrea (ER) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../er/index.ts`,
...
const eritreaCore: CountryPlugin = {
  countryCode: 'ER',
  countryName: 'Eritrea',
  currencyCode: 'ERN',
  currencySymbol: 'Nfk',
  phoneCountryCode: '291',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '291', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const eritreaScaffoldProfile: ExtendedCountryProfile = {
  plugin: eritreaCore,
  languages: ['ti', 'ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'ER-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Eritrea has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const eritreaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../er/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
