/**
 * Pakistan (PK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pk/index.ts`,
...
const pakistanCore: CountryPlugin = {
  countryCode: 'PK',
  countryName: 'Pakistan',
  currencyCode: 'PKR',
  currencySymbol: '₨',
  phoneCountryCode: '92',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '92', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const pakistanScaffoldProfile: ExtendedCountryProfile = {
  plugin: pakistanCore,
  languages: ['ur', 'en'],
  ...
  taxRegime: stubWithholding(
    'PK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Pakistan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const pakistanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pk/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
