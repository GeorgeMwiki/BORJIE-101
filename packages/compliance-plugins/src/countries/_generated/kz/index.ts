/**
 * Kazakhstan (KZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../kz/index.ts`,
...
const kazakhstanCore: CountryPlugin = {
  countryCode: 'KZ',
...
export const kazakhstanScaffoldProfile: ExtendedCountryProfile = {
  plugin: kazakhstanCore,
  languages: ['kk', 'ru'],
  ...
  taxRegime: stubWithholding(
    'KZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Kazakhstan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const kazakhstanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kz/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
