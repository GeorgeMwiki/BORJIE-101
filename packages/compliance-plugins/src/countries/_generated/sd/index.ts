/**
 * Sudan (SD) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sd/index.ts`,
...
const sudanCore: CountryPlugin = {
  countryCode: 'SD',
  countryName: 'Sudan',
  currencyCode: 'SDG',
  currencySymbol: 'ج.س.',
  phoneCountryCode: '249',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '249', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const sudanScaffoldProfile: ExtendedCountryProfile = {
  plugin: sudanCore,
  languages: ['ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'SD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sudan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sudanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sd/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
