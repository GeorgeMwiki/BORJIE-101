/**
 * Romania (RO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ro/index.ts`,
...
const romaniaCore: CountryPlugin = {
  countryCode: 'RO',
  countryName: 'Romania',
  currencyCode: 'RON',
  currencySymbol: 'lei',
  phoneCountryCode: '40',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '40', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const romaniaScaffoldProfile: ExtendedCountryProfile = {
  plugin: romaniaCore,
  languages: ['ro'],
  ...
  taxRegime: stubWithholding(
    'RO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Romania has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const romaniaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ro/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
