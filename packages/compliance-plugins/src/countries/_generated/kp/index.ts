/**
 * Korea, Democratic People's Republic of (KP) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../kp/index.ts`,
...
const koreaDemocraticPeopleSRepublicOfCore: CountryPlugin = {
  countryCode: 'KP',
  countryName: 'Korea, Democratic People\'s Republic of',
  currencyCode: 'KPW',
  currencySymbol: '₩',
  phoneCountryCode: '850',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '850', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const koreaDemocraticPeopleSRepublicOfScaffoldProfile: ExtendedCountryProfile = {
  plugin: koreaDemocraticPeopleSRepublicOfCore,
  languages: ['ko'],
  ...
  taxRegime: stubWithholding(
    'KP-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Korea, Democratic People\'s Republic of has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const koreaDemocraticPeopleSRepublicOfScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kp/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
