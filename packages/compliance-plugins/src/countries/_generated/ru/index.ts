/**
 * Russian Federation (RU) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ru/index.ts`,
...
const russianFederationCore: CountryPlugin = {
  countryCode: 'RU',
  countryName: 'Russian Federation',
  currencyCode: 'RUB',
  currencySymbol: '₽',
  phoneCountryCode: '7',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '7', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const russianFederationScaffoldProfile: ExtendedCountryProfile = {
  plugin: russianFederationCore,
  languages: ['ru'],
  ...
  taxRegime: stubWithholding(
    'RU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Russian Federation has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const russianFederationScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ru/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
