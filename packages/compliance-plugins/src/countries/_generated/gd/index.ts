...
export const grenadaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'GD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Grenada has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const grenadaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gd/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
