/**
 * Sint Maarten (Dutch part) (SX) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sx/index.ts`,
...
const sintMaartenDutchPartCore: CountryPlugin = {
  countryCode: 'SX',
  countryName: 'Sint Maarten (Dutch part)',
  currencyCode: 'ANG',
  currencySymbol: 'ƒ',
  phoneCountryCode: '1721',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1721', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const sintMaartenDutchPartScaffoldProfile: ExtendedCountryProfile = {
  plugin: sintMaartenDutchPartCore,
  languages: ['nl', 'en'],
  ...
  taxRegime: stubWithholding(
    'SX-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sint Maarten (Dutch part) has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sintMaartenDutchPartScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sx/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
