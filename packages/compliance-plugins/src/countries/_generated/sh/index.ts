...
export const saintHelenaAscensionAndTristanDaCunhaScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'SH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Helena, Ascension and Tristan da Cunha has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintHelenaAscensionAndTristanDaCunhaScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sh/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
