/**
 * Afghanistan (AF) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../af/index.ts`,
...
const afghanistanCore: CountryPlugin = {
  countryCode: 'AF',
  countryName: 'Afghanistan',
  currencyCode: 'AFN',
  currencySymbol: '؋',
  phoneCountryCode: '93',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '93', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const afghanistanScaffoldProfile: ExtendedCountryProfile = {
  plugin: afghanistanCore,
  languages: ['ps', 'fa'],
  ...
  taxRegime: stubWithholding(
    'AF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Afghanistan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const afghanistanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../af/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
