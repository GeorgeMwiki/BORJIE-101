/**
 * Micronesia, Federated States of (FM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../fm/index.ts`,
...
const micronesiaFederatedStatesOfCore: CountryPlugin = {
  countryCode: 'FM',
  countryName: 'Micronesia, Federated States of',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '691',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '691', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const micronesiaFederatedStatesOfScaffoldProfile: ExtendedCountryProfile = {
  plugin: micronesiaFederatedStatesOfCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'FM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Micronesia, Federated States of has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const micronesiaFederatedStatesOfScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
