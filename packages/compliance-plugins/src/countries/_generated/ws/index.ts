/**
 * Samoa (WS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ws/index.ts`,
...
const samoaCore: CountryPlugin = {
  countryCode: 'WS',
  countryName: 'Samoa',
  currencyCode: 'WST',
  currencySymbol: 'T',
  phoneCountryCode: '685',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '685', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const samoaScaffoldProfile: ExtendedCountryProfile = {
  plugin: samoaCore,
  languages: ['sm', 'en'],
  ...
  taxRegime: stubWithholding(
    'WS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Samoa has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const samoaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ws/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
