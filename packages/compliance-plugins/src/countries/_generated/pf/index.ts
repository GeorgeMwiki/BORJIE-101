/**
 * French Polynesia (PF) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pf/index.ts`,
...
const frenchPolynesiaCore: CountryPlugin = {
  countryCode: 'PF',
  countryName: 'French Polynesia',
  currencyCode: 'XPF',
  currencySymbol: '₣',
  phoneCountryCode: '689',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '689', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const frenchPolynesiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: frenchPolynesiaCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'PF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: French Polynesia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const frenchPolynesiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pf/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
