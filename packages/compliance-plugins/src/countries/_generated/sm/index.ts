/**
 * San Marino (SM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sm/index.ts`,
...
const sanMarinoCore: CountryPlugin = {
  countryCode: 'SM',
  countryName: 'San Marino',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '378',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '378', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const sanMarinoScaffoldProfile: ExtendedCountryProfile = {
  plugin: sanMarinoCore,
  languages: ['it'],
  ...
  taxRegime: stubWithholding(
    'SM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: San Marino has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sanMarinoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
