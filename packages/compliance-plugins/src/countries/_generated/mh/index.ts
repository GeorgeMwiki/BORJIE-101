/**
 * Marshall Islands (MH) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mh/index.ts`,
...
const marshallIslandsCore: CountryPlugin = {
  countryCode: 'MH',
  countryName: 'Marshall Islands',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '692',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '692', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const marshallIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: marshallIslandsCore,
  languages: ['en', 'mh'],
  ...
  taxRegime: stubWithholding(
    'MH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Marshall Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const marshallIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mh/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
