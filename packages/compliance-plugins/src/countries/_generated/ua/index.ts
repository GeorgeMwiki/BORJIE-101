/**
 * Ukraine (UA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ua/index.ts`,
...
const ukraineCore: CountryPlugin = {
  countryCode: 'UA',
  countryName: 'Ukraine',
  currencyCode: 'UAH',
  currencySymbol: '₴',
  phoneCountryCode: '380',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '380', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const ukraineScaffoldProfile: ExtendedCountryProfile = {
  plugin: ukraineCore,
  languages: ['uk'],
  ...
  taxRegime: stubWithholding(
    'UA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ukraine has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const ukraineScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ua/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
