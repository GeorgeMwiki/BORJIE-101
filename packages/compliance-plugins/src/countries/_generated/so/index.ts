/**
 * Somalia (SO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../so/index.ts`,
...
const somaliaCore: CountryPlugin = {
  countryCode: 'SO',
  countryName: 'Somalia',
  currencyCode: 'SOS',
  currencySymbol: 'Sh',
  phoneCountryCode: '252',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '252', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const somaliaScaffoldProfile: ExtendedCountryProfile = {
  plugin: somaliaCore,
  languages: ['so', 'ar'],
  ...
  taxRegime: stubWithholding(
    'SO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Somalia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const somaliaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../so/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
