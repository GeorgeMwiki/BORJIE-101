/**
 * Malta (MT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mt/index.ts`,
...
const maltaCore: CountryPlugin = {
  countryCode: 'MT',
  countryName: 'Malta',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '356',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '356', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const maltaScaffoldProfile: ExtendedCountryProfile = {
  plugin: maltaCore,
  languages: ['mt', 'en'],
  ...
  taxRegime: stubWithholding(
    'MT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Malta has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const maltaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mt/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
