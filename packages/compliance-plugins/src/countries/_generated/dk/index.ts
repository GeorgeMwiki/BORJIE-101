/**
 * Denmark (DK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../dk/index.ts`,
...
const denmarkCore: CountryPlugin = {
  countryCode: 'DK',
  countryName: 'Denmark',
  currencyCode: 'DKK',
  currencySymbol: 'kr',
  phoneCountryCode: '45',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '45', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const denmarkScaffoldProfile: ExtendedCountryProfile = {
  plugin: denmarkCore,
  languages: ['da'],
  ...
  taxRegime: stubWithholding(
    'DK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Denmark has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const denmarkScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../dk/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
