/**
 * Cambodia (KH) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../kh/index.ts`,
...
const cambodiaCore: CountryPlugin = {
  countryCode: 'KH',
  countryName: 'Cambodia',
  currencyCode: 'KHR',
  currencySymbol: '៛',
  phoneCountryCode: '855',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '855', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const cambodiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: cambodiaCore,
  languages: ['km'],
  ...
  taxRegime: stubWithholding(
    'KH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cambodia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cambodiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kh/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
