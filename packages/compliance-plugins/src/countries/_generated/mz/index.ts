/**
 * Mozambique (MZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mz/index.ts`,
...
const mozambiqueCore: CountryPlugin = {
  countryCode: 'MZ',
  countryName: 'Mozambique',
  currencyCode: 'MZN',
  currencySymbol: 'MT',
  phoneCountryCode: '258',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '258', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const mozambiqueScaffoldProfile: ExtendedCountryProfile = {
  plugin: mozambiqueCore,
  languages: ['pt'],
  ...
  taxRegime: stubWithholding(
    'MZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mozambique has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mozambiqueScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mz/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
