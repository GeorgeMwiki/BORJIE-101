/**
 * Puerto Rico (PR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pr/index.ts`,
...
const puertoRicoCore: CountryPlugin = {
  countryCode: 'PR',
  countryName: 'Puerto Rico',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '1787',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1787', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const puertoRicoScaffoldProfile: ExtendedCountryProfile = {
  plugin: puertoRicoCore,
  languages: ['es', 'en'],
  ...
  taxRegime: stubWithholding(
    'PR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Puerto Rico has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const puertoRicoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pr/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
