/**
 * Mali (ML) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ml/index.ts`,
...
const maliCore: CountryPlugin = {
  countryCode: 'ML',
  countryName: 'Mali',
  currencyCode: 'XOF',
  currencySymbol: 'CFA',
  phoneCountryCode: '223',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '223', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const maliScaffoldProfile: ExtendedCountryProfile = {
  plugin: maliCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'ML-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mali has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const maliScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ml/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
