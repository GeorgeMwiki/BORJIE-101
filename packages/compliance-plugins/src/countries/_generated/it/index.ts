/**
 * Italy (IT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../it/index.ts`,
...
export const italyScaffoldProfile: ExtendedCountryProfile = {
  plugin: italyCore,
  languages: ['it'],
  ...
  taxRegime: stubWithholding(
    'IT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Italy has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const italyScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../it/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
