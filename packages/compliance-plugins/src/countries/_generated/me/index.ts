/**
 * Montenegro (ME) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../me/index.ts`,
...
const montenegroCore: CountryPlugin = {
  countryCode: 'ME',
  countryName: 'Montenegro',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '382',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '382', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const montenegroScaffoldProfile: ExtendedCountryProfile = {
  plugin: montenegroCore,
  languages: ['sr', 'bs', 'sq'],
  ...
  taxRegime: stubWithholding(
    'ME-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Montenegro has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const montenegroScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../me/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
