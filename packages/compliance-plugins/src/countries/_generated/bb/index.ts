/**
 * Barbados (BB) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bb/index.ts`,
...
const barbadosCore: CountryPlugin = {
  countryCode: 'BB',
  countryName: 'Barbados',
  currencyCode: 'BBD',
  currencySymbol: '$',
  phoneCountryCode: '1246',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1246', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const barbadosScaffoldProfile: ExtendedCountryProfile = {
  plugin: barbadosCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'BB-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Barbados has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const barbadosScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bb/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
