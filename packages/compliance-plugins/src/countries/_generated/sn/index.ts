/**
 * Senegal (SN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sn/index.ts`,
...
const senegalCore: CountryPlugin = {
  countryCode: 'SN',
  countryName: 'Senegal',
  currencyCode: 'XOF',
  currencySymbol: 'CFA',
  phoneCountryCode: '221',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '221', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const senegalScaffoldProfile: ExtendedCountryProfile = {
  plugin: senegalCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'SN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Senegal has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const senegalScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
