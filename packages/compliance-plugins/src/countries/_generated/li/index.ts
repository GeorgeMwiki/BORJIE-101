/**
 * Liechtenstein (LI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../li/index.ts`,
...
const liechtensteinCore: CountryPlugin = {
  countryCode: 'LI',
  countryName: 'Liechtenstein',
  currencyCode: 'CHF',
  currencySymbol: 'CHF',
  phoneCountryCode: '423',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '423', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const liechtensteinScaffoldProfile: ExtendedCountryProfile = {
  plugin: liechtensteinCore,
  languages: ['de'],
  ...
  taxRegime: stubWithholding(
    'LI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Liechtenstein has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const liechtensteinScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../li/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
