/**
 * Gambia (GM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gm/index.ts`,
...
const gambiaCore: CountryPlugin = {
  countryCode: 'GM',
  countryName: 'Gambia',
  currencyCode: 'GMD',
  currencySymbol: 'D',
  phoneCountryCode: '220',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '220', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const gambiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: gambiaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'GM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Gambia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const gambiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
