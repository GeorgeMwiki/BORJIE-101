/**
 * Argentina (AR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ar/index.ts`,
...
const argentinaCore: CountryPlugin = {
  countryCode: 'AR',
  countryName: 'Argentina',
  currencyCode: 'ARS',
  currencySymbol: '$',
  phoneCountryCode: '54',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '54', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const argentinaScaffoldProfile: ExtendedCountryProfile = {
  plugin: argentinaCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'AR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Argentina has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const argentinaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ar/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
