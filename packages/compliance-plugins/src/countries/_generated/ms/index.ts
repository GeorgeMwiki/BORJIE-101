/**
 * Montserrat (MS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ms/index.ts`,
...
const montserratCore: CountryPlugin = {
  countryCode: 'MS',
  countryName: 'Montserrat',
  currencyCode: 'XCD',
  currencySymbol: '$',
  phoneCountryCode: '1664',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1664', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const montserratScaffoldProfile: ExtendedCountryProfile = {
  plugin: montserratCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'MS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Montserrat has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const montserratScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ms/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
