/**
 * Switzerland (CH) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ch/index.ts`,
...
const switzerlandCore: CountryPlugin = {
  countryCode: 'CH',
  countryName: 'Switzerland',
  currencyCode: 'CHF',
  currencySymbol: 'CHF',
  phoneCountryCode: '41',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '41', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const switzerlandScaffoldProfile: ExtendedCountryProfile = {
  plugin: switzerlandCore,
  ...
  taxRegime: stubWithholding(
    'CH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Switzerland has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const switzerlandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ch/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
