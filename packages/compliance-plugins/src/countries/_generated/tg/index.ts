/**
 * Togo (TG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tg/index.ts`,
...
const togoCore: CountryPlugin = {
  countryCode: 'TG',
  countryName: 'Togo',
  currencyCode: 'XOF',
  currencySymbol: 'CFA',
  phoneCountryCode: '228',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '228', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const togoScaffoldProfile: ExtendedCountryProfile = {
  plugin: togoCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'TG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Togo has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const togoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
