/**
 * Saint Barthélemy (BL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bl/index.ts`,
...
const saintBarthLemyCore: CountryPlugin = {
  countryCode: 'BL',
...
export const saintBarthLemyScaffoldProfile: ExtendedCountryProfile = {
  plugin: saintBarthLemyCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'BL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Barthélemy has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintBarthLemyScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bl/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
