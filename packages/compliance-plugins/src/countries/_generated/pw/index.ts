/**
 * Palau (PW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pw/index.ts`,
...
const palauCore: CountryPlugin = {
  countryCode: 'PW',
  countryName: 'Palau',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '680',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '680', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const palauScaffoldProfile: ExtendedCountryProfile = {
  plugin: palauCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'PW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Palau has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const palauScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
