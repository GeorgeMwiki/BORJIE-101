/**
 * Guatemala (GT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gt/index.ts`,
...
const guatemalaCore: CountryPlugin = {
  countryCode: 'GT',
  countryName: 'Guatemala',
  currencyCode: 'GTQ',
  currencySymbol: 'Q',
  phoneCountryCode: '502',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '502', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const guatemalaScaffoldProfile: ExtendedCountryProfile = {
  plugin: guatemalaCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'GT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guatemala has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guatemalaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gt/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
