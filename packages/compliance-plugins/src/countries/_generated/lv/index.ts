/**
 * Latvia (LV) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../lv/index.ts`,
...
const latviaCore: CountryPlugin = {
  countryCode: 'LV',
  countryName: 'Latvia',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '371',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '371', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const latviaScaffoldProfile: ExtendedCountryProfile = {
  plugin: latviaCore,
  languages: ['lv'],
  ...
  taxRegime: stubWithholding(
    'LV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Latvia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const latviaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lv/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
