/**
 * Qatar (QA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../qa/index.ts`,
...
const qatarCore: CountryPlugin = {
  countryCode: 'QA',
  countryName: 'Qatar',
  currencyCode: 'QAR',
  currencySymbol: 'ر.ق',
  phoneCountryCode: '974',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '974', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const qatarScaffoldProfile: ExtendedCountryProfile = {
  plugin: qatarCore,
  languages: ['ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'QA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Qatar has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const qatarScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../qa/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
