/**
 * Benin (BJ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bj/index.ts`,
...
const beninCore: CountryPlugin = {
  countryCode: 'BJ',
  countryName: 'Benin',
  currencyCode: 'XOF',
  currencySymbol: 'CFA',
  phoneCountryCode: '229',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '229', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const beninScaffoldProfile: ExtendedCountryProfile = {
  plugin: beninCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'BJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Benin has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const beninScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bj/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
