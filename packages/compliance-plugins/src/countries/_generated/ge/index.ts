/**
 * Georgia (GE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ge/index.ts`,
...
const georgiaCore: CountryPlugin = {
  countryCode: 'GE',
  countryName: 'Georgia',
  currencyCode: 'GEL',
  currencySymbol: '₾',
  phoneCountryCode: '995',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '995', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const georgiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: georgiaCore,
  languages: ['ka'],
  ...
  taxRegime: stubWithholding(
    'GE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Georgia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const georgiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ge/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
