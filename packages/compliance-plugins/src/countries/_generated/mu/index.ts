/**
 * Mauritius (MU) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mu/index.ts`,
...
const mauritiusCore: CountryPlugin = {
  countryCode: 'MU',
  countryName: 'Mauritius',
  currencyCode: 'MUR',
  currencySymbol: '₨',
  phoneCountryCode: '230',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '230', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const mauritiusScaffoldProfile: ExtendedCountryProfile = {
  plugin: mauritiusCore,
  languages: ['en', 'fr'],
  ...
  taxRegime: stubWithholding(
    'MU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mauritius has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mauritiusScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mu/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
