/**
 * Réunion (RE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../re/index.ts`,
...
const rUnionCore: CountryPlugin = {
  countryCode: 'RE',
  countryName: 'Réunion',
  currencyCode: 'EUR',
  currencySymbol: '€',
...
export const rUnionScaffoldProfile: ExtendedCountryProfile = {
  plugin: rUnionCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'RE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Réunion has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const rUnionScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../re/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
