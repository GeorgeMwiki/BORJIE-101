/**
 * Slovakia (SK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sk/index.ts`,
...
const slovakiaCore: CountryPlugin = {
  countryCode: 'SK',
  countryName: 'Slovakia',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '421',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '421', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const slovakiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: slovakiaCore,
  languages: ['sk'],
  ...
  taxRegime: stubWithholding(
    'SK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Slovakia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const slovakiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sk/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
