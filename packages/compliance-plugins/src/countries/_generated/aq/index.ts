/**
 * Antarctica (AQ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../aq/index.ts`,
...
const antarcticaCore: CountryPlugin = {
  countryCode: 'AQ',
...
export const antarcticaScaffoldProfile: ExtendedCountryProfile = {
  plugin: antarcticaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'AQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Antarctica has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const antarcticaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../aq/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
