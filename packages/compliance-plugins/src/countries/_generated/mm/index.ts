/**
 * Myanmar (MM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mm/index.ts`,
...
const myanmarCore: CountryPlugin = {
  countryCode: 'MM',
  countryName: 'Myanmar',
  currencyCode: 'MMK',
  currencySymbol: 'K',
  phoneCountryCode: '95',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '95', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const myanmarScaffoldProfile: ExtendedCountryProfile = {
  plugin: myanmarCore,
  languages: ['my'],
  ...
  taxRegime: stubWithholding(
    'MM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Myanmar has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const myanmarScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
