/**
 * Dominica (DM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../dm/index.ts`,
...
const dominicaCore: CountryPlugin = {
  countryCode: 'DM',
  countryName: 'Dominica',
  currencyCode: 'XCD',
  currencySymbol: '$',
  phoneCountryCode: '1767',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1767', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const dominicaScaffoldProfile: ExtendedCountryProfile = {
  plugin: dominicaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'DM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Dominica has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const dominicaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../dm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
