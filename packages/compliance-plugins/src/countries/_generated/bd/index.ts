/**
 * Bangladesh (BD) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bd/index.ts`,
...
const bangladeshCore: CountryPlugin = {
  countryCode: 'BD',
  countryName: 'Bangladesh',
  currencyCode: 'BDT',
  currencySymbol: '৳',
  phoneCountryCode: '880',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '880', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bangladeshScaffoldProfile: ExtendedCountryProfile = {
  plugin: bangladeshCore,
  languages: ['bn', 'en'],
  ...
  taxRegime: stubWithholding(
    'BD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bangladesh has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bangladeshScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bd/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
