/**
 * Saint Martin (French part) (MF) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mf/index.ts`,
...
const saintMartinFrenchPartCore: CountryPlugin = {
  countryCode: 'MF',
  countryName: 'Saint Martin (French part)',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '590',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '590', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const saintMartinFrenchPartScaffoldProfile: ExtendedCountryProfile = {
  plugin: saintMartinFrenchPartCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'MF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Martin (French part) has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintMartinFrenchPartScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mf/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
