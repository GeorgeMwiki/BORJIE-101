/**
 * China (CN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cn/index.ts`,
...
const chinaCore: CountryPlugin = {
  countryCode: 'CN',
  countryName: 'China',
  currencyCode: 'CNY',
  currencySymbol: '¥',
  phoneCountryCode: '86',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '86', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const chinaScaffoldProfile: ExtendedCountryProfile = {
  plugin: chinaCore,
  languages: ['zh'],
  ...
  taxRegime: stubWithholding(
    'CN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: China has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const chinaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
