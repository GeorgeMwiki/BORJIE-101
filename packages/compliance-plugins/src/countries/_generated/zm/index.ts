/**
 * Zambia (ZM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../zm/index.ts`,
...
const zambiaCore: CountryPlugin = {
  countryCode: 'ZM',
  countryName: 'Zambia',
  currencyCode: 'ZMW',
  currencySymbol: 'ZK',
  phoneCountryCode: '260',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '260', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const zambiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: zambiaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'ZM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Zambia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const zambiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../zm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
