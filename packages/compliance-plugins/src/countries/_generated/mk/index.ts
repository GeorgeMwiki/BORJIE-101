/**
 * North Macedonia (MK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mk/index.ts`,
...
const northMacedoniaCore: CountryPlugin = {
  countryCode: 'MK',
  countryName: 'North Macedonia',
  currencyCode: 'MKD',
  currencySymbol: 'ден',
  phoneCountryCode: '389',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '389', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const northMacedoniaScaffoldProfile: ExtendedCountryProfile = {
  plugin: northMacedoniaCore,
  languages: ['mk'],
  ...
  taxRegime: stubWithholding(
    'MK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: North Macedonia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const northMacedoniaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mk/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
