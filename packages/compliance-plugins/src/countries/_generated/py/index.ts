/**
 * Paraguay (PY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../py/index.ts`,
...
const paraguayCore: CountryPlugin = {
  countryCode: 'PY',
  countryName: 'Paraguay',
  currencyCode: 'PYG',
  currencySymbol: '₲',
  phoneCountryCode: '595',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '595', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const paraguayScaffoldProfile: ExtendedCountryProfile = {
  plugin: paraguayCore,
  languages: ['es', 'gn'],
  ...
  taxRegime: stubWithholding(
    'PY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Paraguay has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const paraguayScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../py/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
