/**
 * Côte d'Ivoire (CI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ci/index.ts`,
...
const cTeDIvoireCore: CountryPlugin = {
  countryCode: 'CI',
  countryName: 'Côte d\'Ivoire',
  currencyCode: 'XOF',
  currencySymbol: 'CFA',
  phoneCountryCode: '225',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '225', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const cTeDIvoireScaffoldProfile: ExtendedCountryProfile = {
  plugin: cTeDIvoireCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'CI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Côte d\'Ivoire has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cTeDIvoireScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ci/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
