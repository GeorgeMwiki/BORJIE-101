/**
 * Iceland (IS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../is/index.ts`,
...
const icelandCore: CountryPlugin = {
  countryCode: 'IS',
  countryName: 'Iceland',
  currencyCode: 'ISK',
  currencySymbol: 'kr',
  phoneCountryCode: '354',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '354', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const icelandScaffoldProfile: ExtendedCountryProfile = {
  plugin: icelandCore,
  languages: ['is'],
  ...
  taxRegime: stubWithholding(
    'IS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Iceland has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const icelandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../is/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
