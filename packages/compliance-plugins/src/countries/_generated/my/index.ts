/**
 * Malaysia (MY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../my/index.ts`,
...
const malaysiaCore: CountryPlugin = {
  countryCode: 'MY',
  countryName: 'Malaysia',
  currencyCode: 'MYR',
  currencySymbol: 'RM',
  phoneCountryCode: '60',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '60', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const malaysiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: malaysiaCore,
  languages: ['ms', 'en'],
  ...
  taxRegime: stubWithholding(
    'MY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Malaysia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const malaysiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../my/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
