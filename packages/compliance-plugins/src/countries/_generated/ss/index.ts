/**
 * South Sudan (SS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ss/index.ts`,
...
const southSudanCore: CountryPlugin = {
  countryCode: 'SS',
  countryName: 'South Sudan',
  currencyCode: 'SSP',
  currencySymbol: '£',
  phoneCountryCode: '211',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '211', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const southSudanScaffoldProfile: ExtendedCountryProfile = {
  plugin: southSudanCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'SS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: South Sudan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const southSudanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ss/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
