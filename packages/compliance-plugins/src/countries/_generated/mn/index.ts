/**
 * Mongolia (MN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mn/index.ts`,
...
const mongoliaCore: CountryPlugin = {
  countryCode: 'MN',
  countryName: 'Mongolia',
  currencyCode: 'MNT',
  currencySymbol: '₮',
  phoneCountryCode: '976',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '976', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const mongoliaScaffoldProfile: ExtendedCountryProfile = {
  plugin: mongoliaCore,
  languages: ['mn'],
  ...
  taxRegime: stubWithholding(
    'MN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mongolia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mongoliaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
