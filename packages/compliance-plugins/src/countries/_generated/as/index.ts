/**
 * American Samoa (AS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../as/index.ts`,
...
const americanSamoaCore: CountryPlugin = {
  countryCode: 'AS',
  countryName: 'American Samoa',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '1684',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1684', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const americanSamoaScaffoldProfile: ExtendedCountryProfile = {
  plugin: americanSamoaCore,
  languages: ['en', 'sm'],
  ...
  taxRegime: stubWithholding(
    'AS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: American Samoa has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const americanSamoaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../as/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
