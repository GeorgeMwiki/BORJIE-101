/**
 * Israel (IL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../il/index.ts`,
...
const israelCore: CountryPlugin = {
  countryCode: 'IL',
  countryName: 'Israel',
  currencyCode: 'ILS',
  currencySymbol: '₪',
  phoneCountryCode: '972',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '972', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const israelScaffoldProfile: ExtendedCountryProfile = {
  plugin: israelCore,
  languages: ['he', 'ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'IL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Israel has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const israelScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../il/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
