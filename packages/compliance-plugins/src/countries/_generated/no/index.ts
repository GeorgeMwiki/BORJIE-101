/**
 * Norway (NO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../no/index.ts`,
...
const norwayCore: CountryPlugin = {
  countryCode: 'NO',
  countryName: 'Norway',
  currencyCode: 'NOK',
  currencySymbol: 'kr',
...
export const norwayScaffoldProfile: ExtendedCountryProfile = {
  plugin: norwayCore,
  languages: ['no'],
  ...
  taxRegime: stubWithholding(
    'NO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Norway has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const norwayScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../no/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
