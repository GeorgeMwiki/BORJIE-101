/**
 * Falkland Islands (Malvinas) (FK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../fk/index.ts`,
...
const falklandIslandsMalvinasCore: CountryPlugin = {
  countryCode: 'FK',
...
export const falklandIslandsMalvinasScaffoldProfile: ExtendedCountryProfile = {
  plugin: falklandIslandsMalvinasCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'FK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Falkland Islands (Malvinas) has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const falklandIslandsMalvinasScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fk/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
