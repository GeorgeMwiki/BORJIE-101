/**
 * Spain (ES) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../es/index.ts`,
...
const spainCore: CountryPlugin = {
  countryCode: 'ES',
  countryName: 'Spain',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '34',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '34', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const spainScaffoldProfile: ExtendedCountryProfile = {
  plugin: spainCore,
  ...
  taxRegime: stubWithholding(
    'ES-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Spain has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const spainScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../es/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
