/**
 * Congo (CG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cg/index.ts`,
...
const congoCore: CountryPlugin = {
  countryCode: 'CG',
  countryName: 'Congo',
  currencyCode: 'XAF',
  currencySymbol: 'FCFA',
  phoneCountryCode: '242',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '242', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const congoScaffoldProfile: ExtendedCountryProfile = {
  plugin: congoCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'CG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Congo has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const congoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
