/**
 * Bosnia and Herzegovina (BA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ba/index.ts`,
...
const bosniaAndHerzegovinaCore: CountryPlugin = {
  countryCode: 'BA',
  countryName: 'Bosnia and Herzegovina',
  currencyCode: 'BAM',
  currencySymbol: 'KM',
  phoneCountryCode: '387',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '387', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bosniaAndHerzegovinaScaffoldProfile: ExtendedCountryProfile = {
  plugin: bosniaAndHerzegovinaCore,
  languages: ['bs', 'hr', 'sr'],
  ...
  taxRegime: stubWithholding(
    'BA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bosnia and Herzegovina has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bosniaAndHerzegovinaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ba/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
