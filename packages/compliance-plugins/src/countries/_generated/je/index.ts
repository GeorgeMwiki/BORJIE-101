/**
 * Jersey (JE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../je/index.ts`,
...
const jerseyCore: CountryPlugin = {
  countryCode: 'JE',
  countryName: 'Jersey',
  currencyCode: 'GBP',
  currencySymbol: '£',
...
export const jerseyScaffoldProfile: ExtendedCountryProfile = {
  plugin: jerseyCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'JE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Jersey has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const jerseyScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../je/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
