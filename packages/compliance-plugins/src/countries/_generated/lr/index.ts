/**
 * Liberia (LR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../lr/index.ts`,
...
const liberiaCore: CountryPlugin = {
  countryCode: 'LR',
  countryName: 'Liberia',
  currencyCode: 'LRD',
  currencySymbol: '$',
  phoneCountryCode: '231',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '231', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const liberiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: liberiaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'LR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Liberia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const liberiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lr/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
