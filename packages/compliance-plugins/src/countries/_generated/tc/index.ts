/**
 * Turks and Caicos Islands (TC) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tc/index.ts`,
...
const turksAndCaicosIslandsCore: CountryPlugin = {
  countryCode: 'TC',
  countryName: 'Turks and Caicos Islands',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '1649',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1649', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const turksAndCaicosIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: turksAndCaicosIslandsCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'TC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Turks and Caicos Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const turksAndCaicosIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tc/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
