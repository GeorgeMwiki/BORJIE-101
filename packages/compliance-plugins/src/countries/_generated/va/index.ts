/**
 * Holy See (Vatican City State) (VA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../va/index.ts`,
...
const holySeeVaticanCityStateCore: CountryPlugin = {
  countryCode: 'VA',
  countryName: 'Holy See (Vatican City State)',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '39',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '39', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const holySeeVaticanCityStateScaffoldProfile: ExtendedCountryProfile = {
  plugin: holySeeVaticanCityStateCore,
  languages: ['it', 'la'],
  ...
  taxRegime: stubWithholding(
    'VA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Holy See (Vatican City State) has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const holySeeVaticanCityStateScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../va/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
