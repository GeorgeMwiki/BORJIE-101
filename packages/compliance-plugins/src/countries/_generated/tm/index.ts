/**
 * Turkmenistan (TM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tm/index.ts`,
...
const turkmenistanCore: CountryPlugin = {
  countryCode: 'TM',
  countryName: 'Turkmenistan',
  currencyCode: 'TMT',
  currencySymbol: 'T',
  phoneCountryCode: '993',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '993', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const turkmenistanScaffoldProfile: ExtendedCountryProfile = {
  plugin: turkmenistanCore,
  languages: ['tk'],
  ...
  taxRegime: stubWithholding(
    'TM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Turkmenistan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const turkmenistanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
