/**
 * Central African Republic (CF) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cf/index.ts`,
...
const centralAfricanRepublicCore: CountryPlugin = {
  countryCode: 'CF',
  countryName: 'Central African Republic',
  currencyCode: 'XAF',
  currencySymbol: 'FCFA',
  phoneCountryCode: '236',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '236', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const centralAfricanRepublicScaffoldProfile: ExtendedCountryProfile = {
  plugin: centralAfricanRepublicCore,
  languages: ['fr', 'sg'],
  ...
  taxRegime: stubWithholding(
    'CF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Central African Republic has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const centralAfricanRepublicScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cf/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
