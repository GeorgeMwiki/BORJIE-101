/**
 * Andorra (AD) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ad/index.ts`,
...
const andorraCore: CountryPlugin = {
  countryCode: 'AD',
  countryName: 'Andorra',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '376',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '376', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const andorraScaffoldProfile: ExtendedCountryProfile = {
  plugin: andorraCore,
  languages: ['ca', 'es', 'fr'],
  ...
  taxRegime: stubWithholding(
    'AD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Andorra has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const andorraScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ad/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
