/**
 * Colombia (CO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../co/index.ts`,
...
const colombiaCore: CountryPlugin = {
  countryCode: 'CO',
  countryName: 'Colombia',
  currencyCode: 'COP',
  currencySymbol: '$',
  phoneCountryCode: '57',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '57', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const colombiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: colombiaCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'CO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Colombia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const colombiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../co/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
