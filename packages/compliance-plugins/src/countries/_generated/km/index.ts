/**
 * Comoros (KM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../km/index.ts`,
...
const comorosCore: CountryPlugin = {
  countryCode: 'KM',
  countryName: 'Comoros',
  currencyCode: 'KMF',
  currencySymbol: 'CF',
  phoneCountryCode: '269',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '269', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const comorosScaffoldProfile: ExtendedCountryProfile = {
  plugin: comorosCore,
  languages: ['fr', 'ar'],
  ...
  taxRegime: stubWithholding(
    'KM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Comoros has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const comorosScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../km/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
