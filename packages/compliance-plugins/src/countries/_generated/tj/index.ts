/**
 * Tajikistan (TJ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tj/index.ts`,
...
const tajikistanCore: CountryPlugin = {
  countryCode: 'TJ',
  countryName: 'Tajikistan',
  currencyCode: 'TJS',
  currencySymbol: 'SM',
  phoneCountryCode: '992',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '992', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const tajikistanScaffoldProfile: ExtendedCountryProfile = {
  plugin: tajikistanCore,
  languages: ['tg'],
  ...
  taxRegime: stubWithholding(
    'TJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tajikistan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tajikistanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tj/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
