/**
 * Algeria (DZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../dz/index.ts`,
...
const algeriaCore: CountryPlugin = {
  countryCode: 'DZ',
  countryName: 'Algeria',
  currencyCode: 'DZD',
  currencySymbol: 'د.ج',
  phoneCountryCode: '213',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '213', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const algeriaScaffoldProfile: ExtendedCountryProfile = {
  plugin: algeriaCore,
  languages: ['ar', 'fr'],
  ...
  taxRegime: stubWithholding(
    'DZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Algeria has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const algeriaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../dz/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
