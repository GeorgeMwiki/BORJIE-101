/**
 * Bahrain (BH) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bh/index.ts`,
...
const bahrainCore: CountryPlugin = {
  countryCode: 'BH',
  countryName: 'Bahrain',
  currencyCode: 'BHD',
  currencySymbol: '.د.ب',
  phoneCountryCode: '973',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '973', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bahrainScaffoldProfile: ExtendedCountryProfile = {
  plugin: bahrainCore,
  languages: ['ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'BH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bahrain has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bahrainScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bh/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
