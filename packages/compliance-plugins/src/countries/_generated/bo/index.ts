/**
 * Bolivia (BO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bo/index.ts`,
...
const boliviaCore: CountryPlugin = {
  countryCode: 'BO',
  countryName: 'Bolivia',
  currencyCode: 'BOB',
  currencySymbol: 'Bs.',
  phoneCountryCode: '591',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '591', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const boliviaScaffoldProfile: ExtendedCountryProfile = {
  plugin: boliviaCore,
  languages: ['es', 'qu', 'ay'],
  ...
  taxRegime: stubWithholding(
    'BO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bolivia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const boliviaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bo/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
