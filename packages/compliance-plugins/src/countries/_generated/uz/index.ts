/**
 * Uzbekistan (UZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../uz/index.ts`,
...
const uzbekistanCore: CountryPlugin = {
  countryCode: 'UZ',
  countryName: 'Uzbekistan',
  currencyCode: 'UZS',
  currencySymbol: 'сўм',
  phoneCountryCode: '998',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '998', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const uzbekistanScaffoldProfile: ExtendedCountryProfile = {
  plugin: uzbekistanCore,
  languages: ['uz'],
  ...
  taxRegime: stubWithholding(
    'UZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Uzbekistan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const uzbekistanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../uz/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
