/**
 * Estonia (EE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ee/index.ts`,
...
const estoniaCore: CountryPlugin = {
  countryCode: 'EE',
  countryName: 'Estonia',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '372',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '372', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const estoniaScaffoldProfile: ExtendedCountryProfile = {
  plugin: estoniaCore,
  languages: ['et', 'en'],
  ...
  taxRegime: stubWithholding(
    'EE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Estonia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const estoniaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ee/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
