/**
 * Faroe Islands (FO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../fo/index.ts`,
...
const faroeIslandsCore: CountryPlugin = {
  countryCode: 'FO',
  countryName: 'Faroe Islands',
  currencyCode: 'DKK',
  currencySymbol: 'kr',
  phoneCountryCode: '298',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '298', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const faroeIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: faroeIslandsCore,
  languages: ['fo', 'da'],
  ...
  taxRegime: stubWithholding(
    'FO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Faroe Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const faroeIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../fo/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
