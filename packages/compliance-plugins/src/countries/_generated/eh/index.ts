/**
 * Western Sahara (EH) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../eh/index.ts`,
...
const westernSaharaCore: CountryPlugin = {
  countryCode: 'EH',
  countryName: 'Western Sahara',
  currencyCode: 'MAD',
  currencySymbol: 'د.م.',
  phoneCountryCode: '212',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '212', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const westernSaharaScaffoldProfile: ExtendedCountryProfile = {
  plugin: westernSaharaCore,
  languages: ['ar'],
  ...
  taxRegime: stubWithholding(
    'EH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Western Sahara has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const westernSaharaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../eh/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
