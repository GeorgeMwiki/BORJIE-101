/**
 * Panama (PA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pa/index.ts`,
...
const panamaCore: CountryPlugin = {
  countryCode: 'PA',
  countryName: 'Panama',
  currencyCode: 'PAB',
  currencySymbol: 'B/.',
  phoneCountryCode: '507',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '507', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const panamaScaffoldProfile: ExtendedCountryProfile = {
  plugin: panamaCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'PA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Panama has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const panamaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pa/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
