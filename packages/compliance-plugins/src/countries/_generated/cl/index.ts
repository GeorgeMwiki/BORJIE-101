/**
 * Chile (CL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cl/index.ts`,
...
const chileCore: CountryPlugin = {
  countryCode: 'CL',
  countryName: 'Chile',
  currencyCode: 'CLP',
  currencySymbol: '$',
  phoneCountryCode: '56',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '56', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const chileScaffoldProfile: ExtendedCountryProfile = {
  plugin: chileCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'CL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Chile has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const chileScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cl/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
