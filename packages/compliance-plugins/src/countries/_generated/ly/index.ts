/**
 * Libya (LY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ly/index.ts`,
...
const libyaCore: CountryPlugin = {
  countryCode: 'LY',
  countryName: 'Libya',
  currencyCode: 'LYD',
  currencySymbol: 'ل.د',
  phoneCountryCode: '218',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '218', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const libyaScaffoldProfile: ExtendedCountryProfile = {
  plugin: libyaCore,
  languages: ['ar'],
  ...
  taxRegime: stubWithholding(
    'LY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Libya has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const libyaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ly/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
