/**
 * Kyrgyzstan (KG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../kg/index.ts`,
...
const kyrgyzstanCore: CountryPlugin = {
  countryCode: 'KG',
  countryName: 'Kyrgyzstan',
  currencyCode: 'KGS',
  currencySymbol: 'с',
  phoneCountryCode: '996',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '996', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const kyrgyzstanScaffoldProfile: ExtendedCountryProfile = {
  plugin: kyrgyzstanCore,
  languages: ['ky', 'ru'],
  ...
  taxRegime: stubWithholding(
    'KG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Kyrgyzstan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const kyrgyzstanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
