/**
 * Angola (AO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ao/index.ts`,
...
const angolaCore: CountryPlugin = {
  countryCode: 'AO',
  countryName: 'Angola',
  currencyCode: 'AOA',
  currencySymbol: 'Kz',
  phoneCountryCode: '244',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '244', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const angolaScaffoldProfile: ExtendedCountryProfile = {
  plugin: angolaCore,
  languages: ['pt'],
  ...
  taxRegime: stubWithholding(
    'AO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Angola has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const angolaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ao/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
