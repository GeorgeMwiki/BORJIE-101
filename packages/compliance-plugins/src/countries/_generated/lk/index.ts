/**
 * Sri Lanka (LK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../lk/index.ts`,
...
const sriLankaCore: CountryPlugin = {
  countryCode: 'LK',
  countryName: 'Sri Lanka',
  currencyCode: 'LKR',
  currencySymbol: '₨',
  phoneCountryCode: '94',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '94', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const sriLankaScaffoldProfile: ExtendedCountryProfile = {
  plugin: sriLankaCore,
  languages: ['si', 'ta', 'en'],
  ...
  taxRegime: stubWithholding(
    'LK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sri Lanka has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sriLankaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lk/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
