/**
 * Bermuda (BM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bm/index.ts`,
...
const bermudaCore: CountryPlugin = {
  countryCode: 'BM',
  countryName: 'Bermuda',
  currencyCode: 'BMD',
  currencySymbol: '$',
  phoneCountryCode: '1441',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1441', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bermudaScaffoldProfile: ExtendedCountryProfile = {
  plugin: bermudaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'BM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bermuda has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bermudaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
