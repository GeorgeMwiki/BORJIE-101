/**
 * Ghana (GH) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gh/index.ts`,
...
const ghanaCore: CountryPlugin = {
  countryCode: 'GH',
  countryName: 'Ghana',
  currencyCode: 'GHS',
  currencySymbol: '₵',
  phoneCountryCode: '233',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '233', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const ghanaScaffoldProfile: ExtendedCountryProfile = {
  plugin: ghanaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'GH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ghana has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const ghanaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gh/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
