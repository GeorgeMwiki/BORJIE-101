/**
 * Taiwan, Province of China (TW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tw/index.ts`,
...
const taiwanProvinceOfChinaCore: CountryPlugin = {
  countryCode: 'TW',
  countryName: 'Taiwan, Province of China',
  currencyCode: 'TWD',
  currencySymbol: 'NT$',
  phoneCountryCode: '886',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '886', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const taiwanProvinceOfChinaScaffoldProfile: ExtendedCountryProfile = {
  plugin: taiwanProvinceOfChinaCore,
  languages: ['zh'],
  ...
  taxRegime: stubWithholding(
    'TW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Taiwan, Province of China has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const taiwanProvinceOfChinaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
