/**
 * Netherlands (NL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../nl/index.ts`,
...
const netherlandsCore: CountryPlugin = {
  countryCode: 'NL',
  countryName: 'Netherlands',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '31',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '31', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const netherlandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: netherlandsCore,
  languages: ['nl'],
  ...
  taxRegime: stubWithholding(
    'NL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Netherlands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const netherlandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nl/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
