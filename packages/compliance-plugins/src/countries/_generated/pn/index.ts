/**
 * Pitcairn (PN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pn/index.ts`,
...
const pitcairnCore: CountryPlugin = {
  countryCode: 'PN',
...
export const pitcairnScaffoldProfile: ExtendedCountryProfile = {
  plugin: pitcairnCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'PN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Pitcairn has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const pitcairnScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
