/**
 * Iraq (IQ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../iq/index.ts`,
...
const iraqCore: CountryPlugin = {
  countryCode: 'IQ',
  countryName: 'Iraq',
  currencyCode: 'IQD',
  currencySymbol: 'ع.د',
  phoneCountryCode: '964',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '964', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const iraqScaffoldProfile: ExtendedCountryProfile = {
  plugin: iraqCore,
  languages: ['ar', 'ku'],
  ...
  taxRegime: stubWithholding(
    'IQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Iraq has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const iraqScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../iq/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
