/**
 * Chad (TD) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../td/index.ts`,
...
const chadCore: CountryPlugin = {
  countryCode: 'TD',
  countryName: 'Chad',
  currencyCode: 'XAF',
  currencySymbol: 'FCFA',
  phoneCountryCode: '235',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '235', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const chadScaffoldProfile: ExtendedCountryProfile = {
  plugin: chadCore,
  languages: ['fr', 'ar'],
  ...
  taxRegime: stubWithholding(
    'TD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Chad has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const chadScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../td/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
