/**
 * Türkiye (TR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tr/index.ts`,
...
const tRkiyeCore: CountryPlugin = {
  countryCode: 'TR',
  countryName: 'Türkiye',
  currencyCode: 'TRY',
  currencySymbol: '₺',
  phoneCountryCode: '90',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '90', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const tRkiyeScaffoldProfile: ExtendedCountryProfile = {
  plugin: tRkiyeCore,
  languages: ['tr'],
  ...
  taxRegime: stubWithholding(
    'TR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Türkiye has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tRkiyeScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tr/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
