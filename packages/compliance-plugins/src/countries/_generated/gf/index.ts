/**
 * French Guiana (GF) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gf/index.ts`,
...
const frenchGuianaCore: CountryPlugin = {
  countryCode: 'GF',
  countryName: 'French Guiana',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '594',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '594', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const frenchGuianaScaffoldProfile: ExtendedCountryProfile = {
  plugin: frenchGuianaCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'GF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: French Guiana has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const frenchGuianaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gf/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
