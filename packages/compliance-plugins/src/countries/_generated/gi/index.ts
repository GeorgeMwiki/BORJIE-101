/**
 * Gibraltar (GI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gi/index.ts`,
...
const gibraltarCore: CountryPlugin = {
  countryCode: 'GI',
  countryName: 'Gibraltar',
  currencyCode: 'GIP',
  currencySymbol: '£',
  phoneCountryCode: '350',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '350', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const gibraltarScaffoldProfile: ExtendedCountryProfile = {
  plugin: gibraltarCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'GI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Gibraltar has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const gibraltarScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gi/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
