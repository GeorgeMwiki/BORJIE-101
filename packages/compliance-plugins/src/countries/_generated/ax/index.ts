/**
 * Åland Islands (AX) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ax/index.ts`,
...
const landIslandsCore: CountryPlugin = {
  countryCode: 'AX',
  countryName: 'Åland Islands',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '358',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '358', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const landIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: landIslandsCore,
  languages: ['sv'],
  ...
  taxRegime: stubWithholding(
    'AX-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Åland Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const landIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ax/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
