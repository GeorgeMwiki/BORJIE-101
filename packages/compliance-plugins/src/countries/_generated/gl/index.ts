/**
 * Greenland (GL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gl/index.ts`,
...
const greenlandCore: CountryPlugin = {
  countryCode: 'GL',
  countryName: 'Greenland',
  currencyCode: 'DKK',
  currencySymbol: 'kr',
  phoneCountryCode: '299',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '299', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const greenlandScaffoldProfile: ExtendedCountryProfile = {
  plugin: greenlandCore,
  languages: ['kl', 'da'],
  ...
  taxRegime: stubWithholding(
    'GL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Greenland has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const greenlandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gl/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
