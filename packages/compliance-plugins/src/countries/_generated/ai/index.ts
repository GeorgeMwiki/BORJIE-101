/**
 * Anguilla (AI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ai/index.ts`,
...
const anguillaCore: CountryPlugin = {
  countryCode: 'AI',
  countryName: 'Anguilla',
  currencyCode: 'XCD',
  currencySymbol: '$',
  phoneCountryCode: '1264',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1264', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const anguillaScaffoldProfile: ExtendedCountryProfile = {
  plugin: anguillaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'AI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Anguilla has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const anguillaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ai/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
