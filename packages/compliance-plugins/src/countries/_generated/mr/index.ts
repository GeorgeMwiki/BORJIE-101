/**
 * Mauritania (MR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mr/index.ts`,
...
const mauritaniaCore: CountryPlugin = {
  countryCode: 'MR',
  countryName: 'Mauritania',
  currencyCode: 'MRU',
  currencySymbol: 'UM',
  phoneCountryCode: '222',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '222', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const mauritaniaScaffoldProfile: ExtendedCountryProfile = {
  plugin: mauritaniaCore,
  languages: ['ar', 'fr'],
  ...
  taxRegime: stubWithholding(
    'MR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Mauritania has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const mauritaniaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mr/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
