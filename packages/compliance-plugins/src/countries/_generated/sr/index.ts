/**
 * Suriname (SR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sr/index.ts`,
...
const surinameCore: CountryPlugin = {
  countryCode: 'SR',
  countryName: 'Suriname',
  currencyCode: 'SRD',
  currencySymbol: '$',
  phoneCountryCode: '597',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '597', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const surinameScaffoldProfile: ExtendedCountryProfile = {
  plugin: surinameCore,
  languages: ['nl'],
  ...
  taxRegime: stubWithholding(
    'SR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Suriname has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const surinameScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sr/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
