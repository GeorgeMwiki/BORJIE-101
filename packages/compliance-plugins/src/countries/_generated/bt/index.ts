/**
 * Bhutan (BT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bt/index.ts`,
...
const bhutanCore: CountryPlugin = {
  countryCode: 'BT',
  countryName: 'Bhutan',
  currencyCode: 'BTN',
  currencySymbol: 'Nu.',
  phoneCountryCode: '975',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '975', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bhutanScaffoldProfile: ExtendedCountryProfile = {
  plugin: bhutanCore,
  languages: ['dz', 'en'],
  ...
  taxRegime: stubWithholding(
    'BT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bhutan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bhutanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bt/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
