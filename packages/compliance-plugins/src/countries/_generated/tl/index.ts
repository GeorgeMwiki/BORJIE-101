/**
 * Timor-Leste (TL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tl/index.ts`,
...
const timorLesteCore: CountryPlugin = {
  countryCode: 'TL',
  countryName: 'Timor-Leste',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '670',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '670', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const timorLesteScaffoldProfile: ExtendedCountryProfile = {
  plugin: timorLesteCore,
  languages: ['pt'],
  ...
  taxRegime: stubWithholding(
    'TL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Timor-Leste has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const timorLesteScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tl/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
