/**
 * Honduras (HN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../hn/index.ts`,
...
const hondurasCore: CountryPlugin = {
  countryCode: 'HN',
  countryName: 'Honduras',
  currencyCode: 'HNL',
  currencySymbol: 'L',
  phoneCountryCode: '504',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '504', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const hondurasScaffoldProfile: ExtendedCountryProfile = {
  plugin: hondurasCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'HN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Honduras has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const hondurasScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
