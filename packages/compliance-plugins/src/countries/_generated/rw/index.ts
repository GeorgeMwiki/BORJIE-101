/**
 * Rwanda (RW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../rw/index.ts`,
...
const rwandaCore: CountryPlugin = {
  countryCode: 'RW',
  countryName: 'Rwanda',
  currencyCode: 'RWF',
  currencySymbol: 'FRw',
  phoneCountryCode: '250',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '250', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const rwandaScaffoldProfile: ExtendedCountryProfile = {
  plugin: rwandaCore,
  languages: ['rw', 'en', 'fr'],
  ...
  taxRegime: stubWithholding(
    'RW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Rwanda has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const rwandaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../rw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
