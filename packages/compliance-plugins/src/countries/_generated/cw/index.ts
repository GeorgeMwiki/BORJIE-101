/**
 * Curaçao (CW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cw/index.ts`,
...
const curaAoCore: CountryPlugin = {
  countryCode: 'CW',
  countryName: 'Curaçao',
  currencyCode: 'ANG',
  currencySymbol: 'ƒ',
...
export const curaAoScaffoldProfile: ExtendedCountryProfile = {
  plugin: curaAoCore,
  languages: ['nl', 'pap', 'en'],
  ...
  taxRegime: stubWithholding(
    'CW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Curaçao has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const curaAoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
