/**
 * Guam (GU) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gu/index.ts`,
...
const guamCore: CountryPlugin = {
  countryCode: 'GU',
  countryName: 'Guam',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '1671',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1671', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const guamScaffoldProfile: ExtendedCountryProfile = {
  plugin: guamCore,
  languages: ['en', 'ch'],
  ...
  taxRegime: stubWithholding(
    'GU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guam has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guamScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gu/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
