/**
 * Uruguay (UY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../uy/index.ts`,
...
const uruguayCore: CountryPlugin = {
  countryCode: 'UY',
  countryName: 'Uruguay',
  currencyCode: 'UYU',
  currencySymbol: '$',
  phoneCountryCode: '598',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '598', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const uruguayScaffoldProfile: ExtendedCountryProfile = {
  plugin: uruguayCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'UY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Uruguay has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const uruguayScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../uy/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
