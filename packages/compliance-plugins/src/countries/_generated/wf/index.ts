/**
 * Wallis and Futuna (WF) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../wf/index.ts`,
...
const wallisAndFutunaCore: CountryPlugin = {
  countryCode: 'WF',
  countryName: 'Wallis and Futuna',
  currencyCode: 'XPF',
  currencySymbol: '₣',
  phoneCountryCode: '681',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '681', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const wallisAndFutunaScaffoldProfile: ExtendedCountryProfile = {
  plugin: wallisAndFutunaCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'WF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Wallis and Futuna has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const wallisAndFutunaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../wf/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
