/**
 * Papua New Guinea (PG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pg/index.ts`,
...
const papuaNewGuineaCore: CountryPlugin = {
  countryCode: 'PG',
  countryName: 'Papua New Guinea',
  currencyCode: 'PGK',
  currencySymbol: 'K',
  phoneCountryCode: '675',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '675', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const papuaNewGuineaScaffoldProfile: ExtendedCountryProfile = {
  plugin: papuaNewGuineaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'PG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Papua New Guinea has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const papuaNewGuineaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
