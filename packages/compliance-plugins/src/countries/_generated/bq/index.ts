/**
 * Bonaire, Sint Eustatius and Saba (BQ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bq/index.ts`,
...
const bonaireSintEustatiusAndSabaCore: CountryPlugin = {
  countryCode: 'BQ',
  countryName: 'Bonaire, Sint Eustatius and Saba',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '599',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '599', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bonaireSintEustatiusAndSabaScaffoldProfile: ExtendedCountryProfile = {
  plugin: bonaireSintEustatiusAndSabaCore,
  languages: ['nl'],
  ...
  taxRegime: stubWithholding(
    'BQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bonaire, Sint Eustatius and Saba has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bonaireSintEustatiusAndSabaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bq/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
