/**
 * Tokelau (TK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tk/index.ts`,
...
const tokelauCore: CountryPlugin = {
  countryCode: 'TK',
  countryName: 'Tokelau',
  currencyCode: 'NZD',
  currencySymbol: '$',
  phoneCountryCode: '690',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '690', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const tokelauScaffoldProfile: ExtendedCountryProfile = {
  plugin: tokelauCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'TK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tokelau has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tokelauScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tk/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
