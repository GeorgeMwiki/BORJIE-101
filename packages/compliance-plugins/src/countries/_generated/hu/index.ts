/**
 * Hungary (HU) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../hu/index.ts`,
...
const hungaryCore: CountryPlugin = {
  countryCode: 'HU',
  countryName: 'Hungary',
  currencyCode: 'HUF',
  currencySymbol: 'Ft',
  phoneCountryCode: '36',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '36', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const hungaryScaffoldProfile: ExtendedCountryProfile = {
  plugin: hungaryCore,
  languages: ['hu'],
  ...
  taxRegime: stubWithholding(
    'HU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Hungary has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const hungaryScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hu/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
