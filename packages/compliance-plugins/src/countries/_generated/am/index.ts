/**
 * Armenia (AM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../am/index.ts`,
...
const armeniaCore: CountryPlugin = {
  countryCode: 'AM',
  countryName: 'Armenia',
  currencyCode: 'AMD',
  currencySymbol: '֏',
  phoneCountryCode: '374',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '374', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const armeniaScaffoldProfile: ExtendedCountryProfile = {
  plugin: armeniaCore,
  languages: ['hy', 'ru'],
  ...
  taxRegime: stubWithholding(
    'AM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Armenia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const armeniaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../am/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
