/**
 * Czechia (CZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cz/index.ts`,
...
const czechiaCore: CountryPlugin = {
  countryCode: 'CZ',
  countryName: 'Czechia',
  currencyCode: 'CZK',
  currencySymbol: 'Kč',
  phoneCountryCode: '420',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '420', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const czechiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: czechiaCore,
  languages: ['cs'],
  ...
  taxRegime: stubWithholding(
    'CZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Czechia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const czechiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cz/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
