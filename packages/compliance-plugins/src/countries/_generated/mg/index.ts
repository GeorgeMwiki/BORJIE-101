/**
 * Madagascar (MG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mg/index.ts`,
...
const madagascarCore: CountryPlugin = {
  countryCode: 'MG',
  countryName: 'Madagascar',
  currencyCode: 'MGA',
  currencySymbol: 'Ar',
  phoneCountryCode: '261',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '261', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const madagascarScaffoldProfile: ExtendedCountryProfile = {
  plugin: madagascarCore,
  languages: ['mg', 'fr'],
  ...
  taxRegime: stubWithholding(
    'MG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Madagascar has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const madagascarScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
