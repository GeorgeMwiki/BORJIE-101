/**
 * Martinique (MQ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mq/index.ts`,
...
const martiniqueCore: CountryPlugin = {
  countryCode: 'MQ',
  countryName: 'Martinique',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '596',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '596', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const martiniqueScaffoldProfile: ExtendedCountryProfile = {
  plugin: martiniqueCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'MQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Martinique has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const martiniqueScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mq/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
