/**
 * Philippines (PH) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ph/index.ts`,
...
const philippinesCore: CountryPlugin = {
  countryCode: 'PH',
  countryName: 'Philippines',
  currencyCode: 'PHP',
  currencySymbol: '₱',
  phoneCountryCode: '63',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '63', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const philippinesScaffoldProfile: ExtendedCountryProfile = {
  plugin: philippinesCore,
  languages: ['fil', 'en'],
  ...
  taxRegime: stubWithholding(
    'PH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Philippines has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const philippinesScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ph/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
