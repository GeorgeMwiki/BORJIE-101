/**
 * Cocos (Keeling) Islands (CC) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cc/index.ts`,
...
const cocosKeelingIslandsCore: CountryPlugin = {
  countryCode: 'CC',
...
export const cocosKeelingIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: cocosKeelingIslandsCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'CC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cocos (Keeling) Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cocosKeelingIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cc/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
