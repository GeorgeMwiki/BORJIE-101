/**
 * French Southern Territories (TF) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tf/index.ts`,
...
const frenchSouthernTerritoriesCore: CountryPlugin = {
  countryCode: 'TF',
  countryName: 'French Southern Territories',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '262',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '262', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const frenchSouthernTerritoriesScaffoldProfile: ExtendedCountryProfile = {
  plugin: frenchSouthernTerritoriesCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'TF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: French Southern Territories has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const frenchSouthernTerritoriesScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tf/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
