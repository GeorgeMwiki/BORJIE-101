/**
 * Burundi (BI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bi/index.ts`,
...
const burundiCore: CountryPlugin = {
  countryCode: 'BI',
  countryName: 'Burundi',
  currencyCode: 'BIF',
  currencySymbol: 'FBu',
  phoneCountryCode: '257',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '257', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const burundiScaffoldProfile: ExtendedCountryProfile = {
  plugin: burundiCore,
  languages: ['fr', 'rn'],
  ...
  taxRegime: stubWithholding(
    'BI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Burundi has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const burundiScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bi/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
