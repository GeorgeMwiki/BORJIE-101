/**
 * Azerbaijan (AZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../az/index.ts`,
...
const azerbaijanCore: CountryPlugin = {
  countryCode: 'AZ',
  countryName: 'Azerbaijan',
  currencyCode: 'AZN',
  currencySymbol: '₼',
  phoneCountryCode: '994',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '994', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const azerbaijanScaffoldProfile: ExtendedCountryProfile = {
  plugin: azerbaijanCore,
  languages: ['az'],
  ...
  taxRegime: stubWithholding(
    'AZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Azerbaijan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const azerbaijanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../az/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
