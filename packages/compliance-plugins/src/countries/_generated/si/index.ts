/**
 * Slovenia (SI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../si/index.ts`,
...
const sloveniaCore: CountryPlugin = {
  countryCode: 'SI',
  countryName: 'Slovenia',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '386',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '386', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const sloveniaScaffoldProfile: ExtendedCountryProfile = {
  plugin: sloveniaCore,
  languages: ['sl'],
  ...
  taxRegime: stubWithholding(
    'SI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Slovenia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const sloveniaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../si/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
