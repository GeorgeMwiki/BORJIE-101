/**
 * Dominican Republic (DO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../do/index.ts`,
...
const dominicanRepublicCore: CountryPlugin = {
  countryCode: 'DO',
  countryName: 'Dominican Republic',
  currencyCode: 'DOP',
  currencySymbol: '$',
  phoneCountryCode: '1809',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1809', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const dominicanRepublicScaffoldProfile: ExtendedCountryProfile = {
  plugin: dominicanRepublicCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'DO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Dominican Republic has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const dominicanRepublicScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../do/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
