/**
 * Antigua and Barbuda (AG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ag/index.ts`,
...
const antiguaAndBarbudaCore: CountryPlugin = {
  countryCode: 'AG',
  countryName: 'Antigua and Barbuda',
  currencyCode: 'XCD',
  currencySymbol: '$',
  phoneCountryCode: '1268',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1268', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const antiguaAndBarbudaScaffoldProfile: ExtendedCountryProfile = {
  plugin: antiguaAndBarbudaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'AG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Antigua and Barbuda has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const antiguaAndBarbudaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ag/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
