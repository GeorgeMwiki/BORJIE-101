/**
 * Nauru (NR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../nr/index.ts`,
...
const nauruCore: CountryPlugin = {
  countryCode: 'NR',
  countryName: 'Nauru',
  currencyCode: 'AUD',
  currencySymbol: '$',
  phoneCountryCode: '674',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '674', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const nauruScaffoldProfile: ExtendedCountryProfile = {
  plugin: nauruCore,
  languages: ['en', 'na'],
  ...
  taxRegime: stubWithholding(
    'NR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Nauru has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const nauruScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nr/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
