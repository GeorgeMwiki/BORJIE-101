/**
 * Cameroon (CM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cm/index.ts`,
...
const cameroonCore: CountryPlugin = {
  countryCode: 'CM',
  countryName: 'Cameroon',
  currencyCode: 'XAF',
  currencySymbol: 'FCFA',
  phoneCountryCode: '237',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '237', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const cameroonScaffoldProfile: ExtendedCountryProfile = {
  plugin: cameroonCore,
  languages: ['fr', 'en'],
  ...
  taxRegime: stubWithholding(
    'CM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cameroon has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cameroonScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
