/**
 * Belarus (BY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../by/index.ts`,
...
const belarusCore: CountryPlugin = {
  countryCode: 'BY',
  countryName: 'Belarus',
  currencyCode: 'BYN',
  currencySymbol: 'Br',
  phoneCountryCode: '375',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '375', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const belarusScaffoldProfile: ExtendedCountryProfile = {
  plugin: belarusCore,
  languages: ['be', 'ru'],
  ...
  taxRegime: stubWithholding(
    'BY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Belarus has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const belarusScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../by/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
