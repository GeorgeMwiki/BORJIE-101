/**
 * Nicaragua (NI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ni/index.ts`,
...
const nicaraguaCore: CountryPlugin = {
  countryCode: 'NI',
  countryName: 'Nicaragua',
  currencyCode: 'NIO',
  currencySymbol: 'C$',
  phoneCountryCode: '505',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '505', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const nicaraguaScaffoldProfile: ExtendedCountryProfile = {
  plugin: nicaraguaCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'NI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Nicaragua has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const nicaraguaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ni/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
