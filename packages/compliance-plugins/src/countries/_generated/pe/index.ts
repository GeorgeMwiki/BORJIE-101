/**
 * Peru (PE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pe/index.ts`,
...
const peruCore: CountryPlugin = {
  countryCode: 'PE',
  countryName: 'Peru',
  currencyCode: 'PEN',
  currencySymbol: 'S/.',
  phoneCountryCode: '51',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '51', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const peruScaffoldProfile: ExtendedCountryProfile = {
  plugin: peruCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'PE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Peru has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const peruScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pe/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
