/**
 * Cuba (CU) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cu/index.ts`,
...
const cubaCore: CountryPlugin = {
  countryCode: 'CU',
  countryName: 'Cuba',
  currencyCode: 'CUP',
  currencySymbol: '$',
  phoneCountryCode: '53',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '53', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const cubaScaffoldProfile: ExtendedCountryProfile = {
  plugin: cubaCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'CU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cuba has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cubaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cu/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
