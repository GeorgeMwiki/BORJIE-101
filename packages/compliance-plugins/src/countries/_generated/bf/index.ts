/**
 * Burkina Faso (BF) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bf/index.ts`,
...
const burkinaFasoCore: CountryPlugin = {
  countryCode: 'BF',
  countryName: 'Burkina Faso',
  currencyCode: 'XOF',
  currencySymbol: 'CFA',
  phoneCountryCode: '226',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '226', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const burkinaFasoScaffoldProfile: ExtendedCountryProfile = {
  plugin: burkinaFasoCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'BF-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Burkina Faso has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const burkinaFasoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bf/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
