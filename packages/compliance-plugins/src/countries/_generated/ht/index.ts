/**
 * Haiti (HT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ht/index.ts`,
...
const haitiCore: CountryPlugin = {
  countryCode: 'HT',
  countryName: 'Haiti',
  currencyCode: 'HTG',
  currencySymbol: 'G',
  phoneCountryCode: '509',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '509', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const haitiScaffoldProfile: ExtendedCountryProfile = {
  plugin: haitiCore,
  languages: ['fr', 'ht'],
  ...
  taxRegime: stubWithholding(
    'HT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Haiti has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const haitiScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ht/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
