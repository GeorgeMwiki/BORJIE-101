/**
 * Luxembourg (LU) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../lu/index.ts`,
...
const luxembourgCore: CountryPlugin = {
  countryCode: 'LU',
  countryName: 'Luxembourg',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '352',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '352', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const luxembourgScaffoldProfile: ExtendedCountryProfile = {
  plugin: luxembourgCore,
  languages: ['lb', 'fr', 'de'],
  ...
  taxRegime: stubWithholding(
    'LU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Luxembourg has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const luxembourgScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lu/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
