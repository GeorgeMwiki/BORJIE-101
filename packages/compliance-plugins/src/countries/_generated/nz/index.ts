/**
 * New Zealand (NZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../nz/index.ts`,
...
const newZealandCore: CountryPlugin = {
  countryCode: 'NZ',
  countryName: 'New Zealand',
  currencyCode: 'NZD',
  currencySymbol: '$',
  phoneCountryCode: '64',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '64', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const newZealandScaffoldProfile: ExtendedCountryProfile = {
  plugin: newZealandCore,
  languages: ['en', 'mi'],
  ...
  taxRegime: stubWithholding(
    'NZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: New Zealand has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const newZealandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nz/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
