/**
 * Venezuela, Bolivarian Republic of (VE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ve/index.ts`,
...
const venezuelaBolivarianRepublicOfCore: CountryPlugin = {
  countryCode: 'VE',
  countryName: 'Venezuela, Bolivarian Republic of',
  currencyCode: 'VES',
  currencySymbol: 'Bs.',
  phoneCountryCode: '58',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '58', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const venezuelaBolivarianRepublicOfScaffoldProfile: ExtendedCountryProfile = {
  plugin: venezuelaBolivarianRepublicOfCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'VE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Venezuela, Bolivarian Republic of has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const venezuelaBolivarianRepublicOfScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ve/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
