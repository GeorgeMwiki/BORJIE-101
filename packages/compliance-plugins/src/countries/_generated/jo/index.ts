/**
 * Jordan (JO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../jo/index.ts`,
...
const jordanCore: CountryPlugin = {
  countryCode: 'JO',
  countryName: 'Jordan',
  currencyCode: 'JOD',
  currencySymbol: 'د.ا',
  phoneCountryCode: '962',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '962', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const jordanScaffoldProfile: ExtendedCountryProfile = {
  plugin: jordanCore,
  languages: ['ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'JO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Jordan has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const jordanScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../jo/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
