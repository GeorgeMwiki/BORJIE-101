/**
 * Ecuador (EC) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ec/index.ts`,
...
const ecuadorCore: CountryPlugin = {
  countryCode: 'EC',
  countryName: 'Ecuador',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '593',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '593', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const ecuadorScaffoldProfile: ExtendedCountryProfile = {
  plugin: ecuadorCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'EC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ecuador has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const ecuadorScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ec/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
