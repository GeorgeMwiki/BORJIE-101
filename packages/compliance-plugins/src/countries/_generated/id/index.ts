/**
 * Indonesia (ID) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../id/index.ts`,
...
const indonesiaCore: CountryPlugin = {
  countryCode: 'ID',
  countryName: 'Indonesia',
  currencyCode: 'IDR',
  currencySymbol: 'Rp',
  phoneCountryCode: '62',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '62', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const indonesiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: indonesiaCore,
  languages: ['id'],
  ...
  taxRegime: stubWithholding(
    'ID-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Indonesia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const indonesiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../id/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
