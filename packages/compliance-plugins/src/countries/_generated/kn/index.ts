/**
 * Saint Kitts and Nevis (KN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../kn/index.ts`,
...
const saintKittsAndNevisCore: CountryPlugin = {
  countryCode: 'KN',
  countryName: 'Saint Kitts and Nevis',
  currencyCode: 'XCD',
  currencySymbol: '$',
  phoneCountryCode: '1869',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1869', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const saintKittsAndNevisScaffoldProfile: ExtendedCountryProfile = {
  plugin: saintKittsAndNevisCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'KN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Kitts and Nevis has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintKittsAndNevisScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
