/**
 * Zimbabwe (ZW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../zw/index.ts`,
...
const zimbabweCore: CountryPlugin = {
  countryCode: 'ZW',
  countryName: 'Zimbabwe',
  currencyCode: 'ZWG',
  currencySymbol: '$',
  phoneCountryCode: '263',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '263', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const zimbabweScaffoldProfile: ExtendedCountryProfile = {
  plugin: zimbabweCore,
  languages: ['en', 'sn', 'nd'],
  ...
  taxRegime: stubWithholding(
    'ZW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Zimbabwe has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const zimbabweScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../zw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
