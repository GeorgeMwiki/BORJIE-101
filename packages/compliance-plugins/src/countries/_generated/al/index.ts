/**
 * Albania (AL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../al/index.ts`,
...
const albaniaCore: CountryPlugin = {
  countryCode: 'AL',
  countryName: 'Albania',
  currencyCode: 'ALL',
  currencySymbol: 'L',
  phoneCountryCode: '355',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '355', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const albaniaScaffoldProfile: ExtendedCountryProfile = {
  plugin: albaniaCore,
  languages: ['sq'],
  ...
  taxRegime: stubWithholding(
    'AL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Albania has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const albaniaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../al/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
