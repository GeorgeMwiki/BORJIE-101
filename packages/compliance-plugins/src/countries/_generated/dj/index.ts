/**
 * Djibouti (DJ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../dj/index.ts`,
...
const djiboutiCore: CountryPlugin = {
  countryCode: 'DJ',
  countryName: 'Djibouti',
  currencyCode: 'DJF',
  currencySymbol: 'Fdj',
  phoneCountryCode: '253',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '253', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const djiboutiScaffoldProfile: ExtendedCountryProfile = {
  plugin: djiboutiCore,
  languages: ['fr', 'ar'],
  ...
  taxRegime: stubWithholding(
    'DJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Djibouti has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const djiboutiScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../dj/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
