/**
 * Saint Lucia (LC) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../lc/index.ts`,
...
const saintLuciaCore: CountryPlugin = {
  countryCode: 'LC',
  countryName: 'Saint Lucia',
  currencyCode: 'XCD',
  currencySymbol: '$',
  phoneCountryCode: '1758',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1758', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const saintLuciaScaffoldProfile: ExtendedCountryProfile = {
  plugin: saintLuciaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'LC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Lucia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintLuciaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lc/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
