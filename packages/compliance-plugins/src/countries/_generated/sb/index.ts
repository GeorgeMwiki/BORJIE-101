/**
 * Solomon Islands (SB) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sb/index.ts`,
...
const solomonIslandsCore: CountryPlugin = {
  countryCode: 'SB',
  countryName: 'Solomon Islands',
  currencyCode: 'SBD',
  currencySymbol: '$',
  phoneCountryCode: '677',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '677', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const solomonIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: solomonIslandsCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'SB-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Solomon Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const solomonIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sb/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
