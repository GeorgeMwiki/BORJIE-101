/**
 * Guadeloupe (GP) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gp/index.ts`,
...
const guadeloupeCore: CountryPlugin = {
  countryCode: 'GP',
...
export const guadeloupeScaffoldProfile: ExtendedCountryProfile = {
  plugin: guadeloupeCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'GP-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guadeloupe has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guadeloupeScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gp/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
