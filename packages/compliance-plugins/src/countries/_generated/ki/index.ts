/**
 * Kiribati (KI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ki/index.ts`,
...
const kiribatiCore: CountryPlugin = {
  countryCode: 'KI',
  countryName: 'Kiribati',
  currencyCode: 'AUD',
  currencySymbol: '$',
  phoneCountryCode: '686',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '686', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const kiribatiScaffoldProfile: ExtendedCountryProfile = {
  plugin: kiribatiCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'KI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Kiribati has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const kiribatiScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ki/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
