/**
 * Nepal (NP) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../np/index.ts`,
...
const nepalCore: CountryPlugin = {
  countryCode: 'NP',
  countryName: 'Nepal',
  currencyCode: 'NPR',
  currencySymbol: '₨',
  phoneCountryCode: '977',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '977', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const nepalScaffoldProfile: ExtendedCountryProfile = {
  plugin: nepalCore,
  languages: ['ne', 'en'],
  ...
  taxRegime: stubWithholding(
    'NP-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Nepal has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const nepalScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../np/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
