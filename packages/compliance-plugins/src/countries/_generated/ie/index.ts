/**
 * Ireland (IE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ie/index.ts`,
...
const irelandCore: CountryPlugin = {
  countryCode: 'IE',
  countryName: 'Ireland',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '353',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '353', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const irelandScaffoldProfile: ExtendedCountryProfile = {
  plugin: irelandCore,
  languages: ['en', 'ga'],
  ...
  taxRegime: stubWithholding(
    'IE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ireland has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const irelandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ie/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
