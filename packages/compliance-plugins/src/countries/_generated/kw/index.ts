/**
 * Kuwait (KW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../kw/index.ts`,
...
const kuwaitCore: CountryPlugin = {
  countryCode: 'KW',
  countryName: 'Kuwait',
  currencyCode: 'KWD',
  currencySymbol: 'د.ك',
  phoneCountryCode: '965',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '965', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const kuwaitScaffoldProfile: ExtendedCountryProfile = {
  plugin: kuwaitCore,
  languages: ['ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'KW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Kuwait has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const kuwaitScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../kw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
