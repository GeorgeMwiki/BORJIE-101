/**
 * Lesotho (LS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ls/index.ts`,
...
const lesothoCore: CountryPlugin = {
  countryCode: 'LS',
  countryName: 'Lesotho',
  currencyCode: 'LSL',
  currencySymbol: 'L',
  phoneCountryCode: '266',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '266', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const lesothoScaffoldProfile: ExtendedCountryProfile = {
  plugin: lesothoCore,
  languages: ['en', 'st'],
  ...
  taxRegime: stubWithholding(
    'LS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Lesotho has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const lesothoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ls/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
