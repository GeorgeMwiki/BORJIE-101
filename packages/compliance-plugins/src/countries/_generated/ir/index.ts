...
export const iranIslamicRepublicOfScaffoldProfile: ExtendedCountryProfile = {
  ...
  taxRegime: stubWithholding(
    'IR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Iran, Islamic Republic of has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const iranIslamicRepublicOfScaffoldMetadata = Object.freeze({
  ...
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ir/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
