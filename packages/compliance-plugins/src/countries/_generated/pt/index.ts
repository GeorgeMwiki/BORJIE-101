/**
 * Portugal (PT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pt/index.ts`,
...
const portugalCore: CountryPlugin = {
  countryCode: 'PT',
  countryName: 'Portugal',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '351',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '351', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const portugalScaffoldProfile: ExtendedCountryProfile = {
  plugin: portugalCore,
  languages: ['pt'],
  ...
  taxRegime: stubWithholding(
    'PT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Portugal has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const portugalScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pt/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
