/**
 * Tonga (TO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../to/index.ts`,
...
const tongaCore: CountryPlugin = {
  countryCode: 'TO',
  countryName: 'Tonga',
  currencyCode: 'TOP',
  currencySymbol: 'T$',
  phoneCountryCode: '676',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '676', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const tongaScaffoldProfile: ExtendedCountryProfile = {
  plugin: tongaCore,
  languages: ['en', 'to'],
  ...
  taxRegime: stubWithholding(
    'TO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tonga has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tongaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../to/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
