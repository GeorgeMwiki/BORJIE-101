/**
 * Austria (AT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../at/index.ts`,
...
const austriaCore: CountryPlugin = {
  countryCode: 'AT',
  countryName: 'Austria',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '43',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '43', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const austriaScaffoldProfile: ExtendedCountryProfile = {
  plugin: austriaCore,
  languages: ['de'],
  ...
  taxRegime: stubWithholding(
    'AT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Austria has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const austriaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../at/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
