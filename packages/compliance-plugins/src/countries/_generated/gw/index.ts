/**
 * Guinea-Bissau (GW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gw/index.ts`,
...
const guineaBissauCore: CountryPlugin = {
  countryCode: 'GW',
  countryName: 'Guinea-Bissau',
  currencyCode: 'XOF',
  currencySymbol: 'CFA',
  phoneCountryCode: '245',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '245', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const guineaBissauScaffoldProfile: ExtendedCountryProfile = {
  plugin: guineaBissauCore,
  languages: ['pt'],
  ...
  taxRegime: stubWithholding(
    'GW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guinea-Bissau has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guineaBissauScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
