/**
 * Virgin Islands, British (VG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../vg/index.ts`,
...
const virginIslandsBritishCore: CountryPlugin = {
  countryCode: 'VG',
  countryName: 'Virgin Islands, British',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '1284',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1284', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const virginIslandsBritishScaffoldProfile: ExtendedCountryProfile = {
  plugin: virginIslandsBritishCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'VG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Virgin Islands, British has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const virginIslandsBritishScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
