/**
 * Cook Islands (CK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ck/index.ts`,
...
const cookIslandsCore: CountryPlugin = {
  countryCode: 'CK',
  countryName: 'Cook Islands',
  currencyCode: 'NZD',
  currencySymbol: '$',
  phoneCountryCode: '682',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '682', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const cookIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: cookIslandsCore,
  languages: ['en', 'mi'],
  ...
  taxRegime: stubWithholding(
    'CK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cook Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cookIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ck/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
