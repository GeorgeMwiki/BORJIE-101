/**
 * Cyprus (CY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cy/index.ts`,
...
const cyprusCore: CountryPlugin = {
  countryCode: 'CY',
  countryName: 'Cyprus',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '357',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '357', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const cyprusScaffoldProfile: ExtendedCountryProfile = {
  plugin: cyprusCore,
  languages: ['el', 'tr', 'en'],
  ...
  taxRegime: stubWithholding(
    'CY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Cyprus has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const cyprusScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cy/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
