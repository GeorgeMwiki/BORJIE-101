/**
 * Guernsey (GG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gg/index.ts`,
...
const guernseyCore: CountryPlugin = {
  countryCode: 'GG',
...
export const guernseyScaffoldProfile: ExtendedCountryProfile = {
  plugin: guernseyCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'GG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guernsey has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guernseyScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
