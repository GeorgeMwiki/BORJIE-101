/**
 * Gabon (GA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ga/index.ts`,
...
const gabonCore: CountryPlugin = {
  countryCode: 'GA',
  countryName: 'Gabon',
  currencyCode: 'XAF',
  currencySymbol: 'FCFA',
  phoneCountryCode: '241',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '241', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const gabonScaffoldProfile: ExtendedCountryProfile = {
  plugin: gabonCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'GA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Gabon has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const gabonScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ga/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
