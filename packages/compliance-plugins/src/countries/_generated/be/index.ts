/**
 * Belgium (BE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../be/index.ts`,
...
const belgiumCore: CountryPlugin = {
  countryCode: 'BE',
  countryName: 'Belgium',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '32',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '32', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const belgiumScaffoldProfile: ExtendedCountryProfile = {
  plugin: belgiumCore,
  languages: ['nl', 'fr', 'de'],
  ...
  taxRegime: stubWithholding(
    'BE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Belgium has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const belgiumScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../be/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
