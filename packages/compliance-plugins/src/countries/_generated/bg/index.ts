/**
 * Bulgaria (BG) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bg/index.ts`,
...
const bulgariaCore: CountryPlugin = {
  countryCode: 'BG',
  countryName: 'Bulgaria',
  currencyCode: 'BGN',
  currencySymbol: 'лв',
  phoneCountryCode: '359',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '359', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bulgariaScaffoldProfile: ExtendedCountryProfile = {
  plugin: bulgariaCore,
  languages: ['bg'],
  ...
  taxRegime: stubWithholding(
    'BG-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bulgaria has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bulgariaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bg/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
