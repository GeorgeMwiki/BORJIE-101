/**
 * Poland (PL) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pl/index.ts`,
...
const polandCore: CountryPlugin = {
  countryCode: 'PL',
  countryName: 'Poland',
  currencyCode: 'PLN',
  currencySymbol: 'zł',
  phoneCountryCode: '48',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '48', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const polandScaffoldProfile: ExtendedCountryProfile = {
  plugin: polandCore,
  languages: ['pl'],
  ...
  taxRegime: stubWithholding(
    'PL-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Poland has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const polandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pl/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
