/**
 * Bahamas (BS) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bs/index.ts`,
...
const bahamasCore: CountryPlugin = {
  countryCode: 'BS',
  countryName: 'Bahamas',
  currencyCode: 'BSD',
  currencySymbol: '$',
  phoneCountryCode: '1242',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1242', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bahamasScaffoldProfile: ExtendedCountryProfile = {
  plugin: bahamasCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'BS-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Bahamas has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bahamasScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bs/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
