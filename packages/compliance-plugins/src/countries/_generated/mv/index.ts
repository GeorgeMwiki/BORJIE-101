/**
 * Maldives (MV) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mv/index.ts`,
...
const maldivesCore: CountryPlugin = {
  countryCode: 'MV',
  countryName: 'Maldives',
  currencyCode: 'MVR',
  currencySymbol: 'Rf',
  phoneCountryCode: '960',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '960', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const maldivesScaffoldProfile: ExtendedCountryProfile = {
  plugin: maldivesCore,
  languages: ['dv', 'en'],
  ...
  taxRegime: stubWithholding(
    'MV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Maldives has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const maldivesScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mv/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
