/**
 * Saudi Arabia (SA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sa/index.ts`,
...
const saudiArabiaCore: CountryPlugin = {
  countryCode: 'SA',
  countryName: 'Saudi Arabia',
  currencyCode: 'SAR',
  currencySymbol: 'ر.س',
  phoneCountryCode: '966',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '966', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const saudiArabiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: saudiArabiaCore,
  languages: ['ar', 'en'],
  ...
  taxRegime: stubWithholding(
    'SA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saudi Arabia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saudiArabiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sa/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
