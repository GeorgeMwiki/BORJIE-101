/**
 * Christmas Island (CX) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cx/index.ts`,
...
const christmasIslandCore: CountryPlugin = {
  countryCode: 'CX',
...
export const christmasIslandScaffoldProfile: ExtendedCountryProfile = {
  plugin: christmasIslandCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'CX-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Christmas Island has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const christmasIslandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cx/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
