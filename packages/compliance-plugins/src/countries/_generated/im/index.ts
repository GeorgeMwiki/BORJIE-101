/**
 * Isle of Man (IM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../im/index.ts`,
...
const isleOfManCore: CountryPlugin = {
  countryCode: 'IM',
...
export const isleOfManScaffoldProfile: ExtendedCountryProfile = {
  plugin: isleOfManCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'IM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Isle of Man has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const isleOfManScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../im/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
