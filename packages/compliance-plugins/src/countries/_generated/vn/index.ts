/**
 * Viet Nam (VN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../vn/index.ts`,
...
const vietNamCore: CountryPlugin = {
  countryCode: 'VN',
  countryName: 'Viet Nam',
  currencyCode: 'VND',
  currencySymbol: '₫',
  phoneCountryCode: '84',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '84', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const vietNamScaffoldProfile: ExtendedCountryProfile = {
  plugin: vietNamCore,
  languages: ['vi'],
  ...
  taxRegime: stubWithholding(
    'VN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Viet Nam has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const vietNamScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
