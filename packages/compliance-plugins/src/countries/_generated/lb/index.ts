/**
 * Lebanon (LB) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../lb/index.ts`,
...
const lebanonCore: CountryPlugin = {
  countryCode: 'LB',
  countryName: 'Lebanon',
  currencyCode: 'LBP',
  currencySymbol: 'ل.ل',
  phoneCountryCode: '961',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '961', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const lebanonScaffoldProfile: ExtendedCountryProfile = {
  plugin: lebanonCore,
  languages: ['ar', 'fr', 'en'],
  ...
  taxRegime: stubWithholding(
    'LB-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Lebanon has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const lebanonScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../lb/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
