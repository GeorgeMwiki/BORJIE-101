/**
 * United States Minor Outlying Islands (UM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../um/index.ts`,
...
const unitedStatesMinorOutlyingIslandsCore: CountryPlugin = {
  countryCode: 'UM',
  countryName: 'United States Minor Outlying Islands',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '1',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const unitedStatesMinorOutlyingIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: unitedStatesMinorOutlyingIslandsCore,
  languages: ['en'],
  dateFormat: 'MM/DD/YYYY' as ExtendedCountryProfile['dateFormat'],
  minorUnitDivisor: 100,
  nationalIdValidator: null,
  taxRegime: stubWithholding(
    'UM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: United States Minor Outlying Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const unitedStatesMinorOutlyingIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../um/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
