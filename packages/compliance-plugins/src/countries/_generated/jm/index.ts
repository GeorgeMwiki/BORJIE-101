/**
 * Jamaica (JM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../jm/index.ts`,
...
const jamaicaCore: CountryPlugin = {
  countryCode: 'JM',
  countryName: 'Jamaica',
  currencyCode: 'JMD',
  currencySymbol: '$',
  phoneCountryCode: '1876',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1876', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const jamaicaScaffoldProfile: ExtendedCountryProfile = {
  plugin: jamaicaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'JM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Jamaica has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const jamaicaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../jm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
