/**
 * Syrian Arab Republic (SY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sy/index.ts`,
...
const syrianArabRepublicCore: CountryPlugin = {
  countryCode: 'SY',
  countryName: 'Syrian Arab Republic',
  currencyCode: 'SYP',
  currencySymbol: '£',
  phoneCountryCode: '963',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '963', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const syrianArabRepublicScaffoldProfile: ExtendedCountryProfile = {
  plugin: syrianArabRepublicCore,
  languages: ['ar'],
  ...
  taxRegime: stubWithholding(
    'SY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Syrian Arab Republic has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const syrianArabRepublicScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sy/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
