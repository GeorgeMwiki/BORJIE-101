/**
 * Ethiopia (ET) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../et/index.ts`,
...
const ethiopiaCore: CountryPlugin = {
  countryCode: 'ET',
  countryName: 'Ethiopia',
  currencyCode: 'ETB',
  currencySymbol: 'Br',
  phoneCountryCode: '251',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '251', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const ethiopiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: ethiopiaCore,
  languages: ['am', 'en'],
  ...
  taxRegime: stubWithholding(
    'ET-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Ethiopia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const ethiopiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../et/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
