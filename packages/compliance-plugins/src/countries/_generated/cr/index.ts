/**
 * Costa Rica (CR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../cr/index.ts`,
...
const costaRicaCore: CountryPlugin = {
  countryCode: 'CR',
  countryName: 'Costa Rica',
  currencyCode: 'CRC',
  currencySymbol: '₡',
  phoneCountryCode: '506',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '506', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const costaRicaScaffoldProfile: ExtendedCountryProfile = {
  plugin: costaRicaCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'CR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Costa Rica has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const costaRicaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../cr/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
