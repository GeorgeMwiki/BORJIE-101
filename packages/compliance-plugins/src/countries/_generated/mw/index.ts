/**
 * Malawi (MW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mw/index.ts`,
...
const malawiCore: CountryPlugin = {
  countryCode: 'MW',
  countryName: 'Malawi',
  currencyCode: 'MWK',
  currencySymbol: 'MK',
  phoneCountryCode: '265',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '265', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const malawiScaffoldProfile: ExtendedCountryProfile = {
  plugin: malawiCore,
  languages: ['en', 'ny'],
  ...
  taxRegime: stubWithholding(
    'MW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Malawi has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const malawiScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
