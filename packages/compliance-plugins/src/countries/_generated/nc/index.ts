/**
 * New Caledonia (NC) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../nc/index.ts`,
...
const newCaledoniaCore: CountryPlugin = {
  countryCode: 'NC',
  countryName: 'New Caledonia',
  currencyCode: 'XPF',
  currencySymbol: '₣',
  phoneCountryCode: '687',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '687', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const newCaledoniaScaffoldProfile: ExtendedCountryProfile = {
  plugin: newCaledoniaCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'NC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: New Caledonia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const newCaledoniaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nc/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
