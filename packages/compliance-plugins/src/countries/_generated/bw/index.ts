/**
 * Botswana (BW) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bw/index.ts`,
...
const botswanaCore: CountryPlugin = {
  countryCode: 'BW',
  countryName: 'Botswana',
  currencyCode: 'BWP',
  currencySymbol: 'P',
  phoneCountryCode: '267',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '267', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const botswanaScaffoldProfile: ExtendedCountryProfile = {
  plugin: botswanaCore,
  languages: ['en', 'tn'],
  ...
  taxRegime: stubWithholding(
    'BW-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Botswana has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const botswanaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bw/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
