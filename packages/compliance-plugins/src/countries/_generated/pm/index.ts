/**
 * Saint Pierre and Miquelon (PM) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../pm/index.ts`,
...
const saintPierreAndMiquelonCore: CountryPlugin = {
  countryCode: 'PM',
  countryName: 'Saint Pierre and Miquelon',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '508',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '508', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const saintPierreAndMiquelonScaffoldProfile: ExtendedCountryProfile = {
  plugin: saintPierreAndMiquelonCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'PM-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Saint Pierre and Miquelon has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const saintPierreAndMiquelonScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../pm/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
