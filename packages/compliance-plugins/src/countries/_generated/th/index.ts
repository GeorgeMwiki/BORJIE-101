/**
 * Thailand (TH) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../th/index.ts`,
...
const thailandCore: CountryPlugin = {
  countryCode: 'TH',
  countryName: 'Thailand',
  currencyCode: 'THB',
  currencySymbol: '฿',
  phoneCountryCode: '66',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '66', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const thailandScaffoldProfile: ExtendedCountryProfile = {
  plugin: thailandCore,
  languages: ['th'],
  ...
  taxRegime: stubWithholding(
    'TH-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Thailand has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const thailandScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../th/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
