/**
 * Brunei Darussalam (BN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bn/index.ts`,
...
const bruneiDarussalamCore: CountryPlugin = {
  countryCode: 'BN',
  countryName: 'Brunei Darussalam',
  currencyCode: 'BND',
  currencySymbol: '$',
  phoneCountryCode: '673',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '673', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const bruneiDarussalamScaffoldProfile: ExtendedCountryProfile = {
  plugin: bruneiDarussalamCore,
  languages: ['ms', 'en'],
  ...
  taxRegime: stubWithholding(
    'BN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Brunei Darussalam has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const bruneiDarussalamScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
