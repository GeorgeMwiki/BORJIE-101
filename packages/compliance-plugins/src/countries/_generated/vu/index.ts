/**
 * Vanuatu (VU) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../vu/index.ts`,
...
const vanuatuCore: CountryPlugin = {
  countryCode: 'VU',
  countryName: 'Vanuatu',
  currencyCode: 'VUV',
  currencySymbol: 'Vt',
  phoneCountryCode: '678',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '678', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const vanuatuScaffoldProfile: ExtendedCountryProfile = {
  plugin: vanuatuCore,
  languages: ['bi', 'en', 'fr'],
  ...
  taxRegime: stubWithholding(
    'VU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Vanuatu has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const vanuatuScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vu/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
