/**
 * Virgin Islands, U.S. (VI) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../vi/index.ts`,
...
const virginIslandsUSCore: CountryPlugin = {
  countryCode: 'VI',
  countryName: 'Virgin Islands, U.S.',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '1340',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1340', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const virginIslandsUSScaffoldProfile: ExtendedCountryProfile = {
  plugin: virginIslandsUSCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'VI-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Virgin Islands, U.S. has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const virginIslandsUSScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../vi/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
