/**
 * Trinidad and Tobago (TT) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tt/index.ts`,
...
const trinidadAndTobagoCore: CountryPlugin = {
  countryCode: 'TT',
  countryName: 'Trinidad and Tobago',
  currencyCode: 'TTD',
  currencySymbol: '$',
  phoneCountryCode: '1868',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1868', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const trinidadAndTobagoScaffoldProfile: ExtendedCountryProfile = {
  plugin: trinidadAndTobagoCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'TT-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Trinidad and Tobago has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const trinidadAndTobagoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tt/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
