/**
 * El Salvador (SV) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sv/index.ts`,
...
const elSalvadorCore: CountryPlugin = {
  countryCode: 'SV',
  countryName: 'El Salvador',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '503',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '503', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const elSalvadorScaffoldProfile: ExtendedCountryProfile = {
  plugin: elSalvadorCore,
  languages: ['es'],
  ...
  taxRegime: stubWithholding(
    'SV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: El Salvador has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const elSalvadorScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sv/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
