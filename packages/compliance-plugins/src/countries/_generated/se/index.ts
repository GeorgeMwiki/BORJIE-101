/**
 * Sweden (SE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../se/index.ts`,
...
const swedenCore: CountryPlugin = {
  countryCode: 'SE',
  countryName: 'Sweden',
  currencyCode: 'SEK',
  currencySymbol: 'kr',
  phoneCountryCode: '46',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '46', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const swedenScaffoldProfile: ExtendedCountryProfile = {
  plugin: swedenCore,
  languages: ['sv'],
  ...
  taxRegime: stubWithholding(
    'SE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Sweden has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const swedenScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../se/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
