/**
 * Croatia (HR) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../hr/index.ts`,
...
const croatiaCore: CountryPlugin = {
  countryCode: 'HR',
  countryName: 'Croatia',
  currencyCode: 'EUR',
  currencySymbol: '€',
  phoneCountryCode: '385',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '385', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const croatiaScaffoldProfile: ExtendedCountryProfile = {
  plugin: croatiaCore,
  languages: ['hr'],
  ...
  taxRegime: stubWithholding(
    'HR-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Croatia has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const croatiaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hr/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
