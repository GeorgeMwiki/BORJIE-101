/**
 * Seychelles (SC) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sc/index.ts`,
...
const seychellesCore: CountryPlugin = {
  countryCode: 'SC',
  countryName: 'Seychelles',
  currencyCode: 'SCR',
  currencySymbol: '₨',
  phoneCountryCode: '248',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '248', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const seychellesScaffoldProfile: ExtendedCountryProfile = {
  plugin: seychellesCore,
  languages: ['en', 'fr'],
  ...
  taxRegime: stubWithholding(
    'SC-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Seychelles has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const seychellesScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sc/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
