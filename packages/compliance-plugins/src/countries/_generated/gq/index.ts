/**
 * Equatorial Guinea (GQ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gq/index.ts`,
...
const equatorialGuineaCore: CountryPlugin = {
  countryCode: 'GQ',
  countryName: 'Equatorial Guinea',
  currencyCode: 'XAF',
  currencySymbol: 'FCFA',
  phoneCountryCode: '240',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '240', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const equatorialGuineaScaffoldProfile: ExtendedCountryProfile = {
  plugin: equatorialGuineaCore,
  languages: ['es', 'fr', 'pt'],
  ...
  taxRegime: stubWithholding(
    'GQ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Equatorial Guinea has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const equatorialGuineaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gq/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
