/**
 * Macao (MO) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mo/index.ts`,
...
const macaoCore: CountryPlugin = {
  countryCode: 'MO',
  countryName: 'Macao',
  currencyCode: 'MOP',
  currencySymbol: 'P',
  phoneCountryCode: '853',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '853', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const macaoScaffoldProfile: ExtendedCountryProfile = {
  plugin: macaoCore,
  languages: ['zh', 'pt'],
  ...
  taxRegime: stubWithholding(
    'MO-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Macao has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const macaoScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mo/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
