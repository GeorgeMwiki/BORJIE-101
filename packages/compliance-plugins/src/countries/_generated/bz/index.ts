/**
 * Belize (BZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../bz/index.ts`,
...
const belizeCore: CountryPlugin = {
  countryCode: 'BZ',
  countryName: 'Belize',
  currencyCode: 'BZD',
  currencySymbol: '$',
  phoneCountryCode: '501',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '501', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const belizeScaffoldProfile: ExtendedCountryProfile = {
  plugin: belizeCore,
  languages: ['en', 'es'],
  ...
  taxRegime: stubWithholding(
    'BZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Belize has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const belizeScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../bz/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
