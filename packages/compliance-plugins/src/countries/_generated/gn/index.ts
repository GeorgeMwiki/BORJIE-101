/**
 * Guinea (GN) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gn/index.ts`,
...
const guineaCore: CountryPlugin = {
  countryCode: 'GN',
  countryName: 'Guinea',
  currencyCode: 'GNF',
  currencySymbol: 'FG',
  phoneCountryCode: '224',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '224', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const guineaScaffoldProfile: ExtendedCountryProfile = {
  plugin: guineaCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'GN-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guinea has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guineaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gn/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
