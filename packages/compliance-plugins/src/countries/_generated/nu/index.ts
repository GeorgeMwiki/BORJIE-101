/**
 * Niue (NU) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../nu/index.ts`,
...
const niueCore: CountryPlugin = {
  countryCode: 'NU',
  countryName: 'Niue',
  currencyCode: 'NZD',
  currencySymbol: '$',
  phoneCountryCode: '683',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '683', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const niueScaffoldProfile: ExtendedCountryProfile = {
  plugin: niueCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'NU-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Niue has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const niueScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../nu/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
