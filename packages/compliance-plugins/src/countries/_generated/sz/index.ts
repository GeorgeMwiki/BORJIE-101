/**
 * Eswatini (SZ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sz/index.ts`,
...
const eswatiniCore: CountryPlugin = {
  countryCode: 'SZ',
  countryName: 'Eswatini',
  currencyCode: 'SZL',
  currencySymbol: 'L',
  phoneCountryCode: '268',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '268', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const eswatiniScaffoldProfile: ExtendedCountryProfile = {
  plugin: eswatiniCore,
  languages: ['en', 'ss'],
  ...
  taxRegime: stubWithholding(
    'SZ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Eswatini has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const eswatiniScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sz/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
