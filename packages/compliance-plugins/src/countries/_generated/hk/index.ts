/**
 * Hong Kong (HK) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../hk/index.ts`,
...
const hongKongCore: CountryPlugin = {
  countryCode: 'HK',
  countryName: 'Hong Kong',
  currencyCode: 'HKD',
  currencySymbol: '$',
  phoneCountryCode: '852',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '852', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const hongKongScaffoldProfile: ExtendedCountryProfile = {
  plugin: hongKongCore,
  languages: ['zh', 'en'],
  ...
  taxRegime: stubWithholding(
    'HK-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Hong Kong has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const hongKongScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../hk/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
