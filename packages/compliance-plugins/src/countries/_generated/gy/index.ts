/**
 * Guyana (GY) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../gy/index.ts`,
...
const guyanaCore: CountryPlugin = {
  countryCode: 'GY',
  countryName: 'Guyana',
  currencyCode: 'GYD',
  currencySymbol: '$',
  phoneCountryCode: '592',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '592', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const guyanaScaffoldProfile: ExtendedCountryProfile = {
  plugin: guyanaCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'GY-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Guyana has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const guyanaScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../gy/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
