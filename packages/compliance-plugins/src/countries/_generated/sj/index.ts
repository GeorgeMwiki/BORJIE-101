/**
 * Svalbard and Jan Mayen (SJ) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../sj/index.ts`,
...
const svalbardAndJanMayenCore: CountryPlugin = {
  countryCode: 'SJ',
  countryName: 'Svalbard and Jan Mayen',
  currencyCode: 'NOK',
  currencySymbol: 'kr',
  phoneCountryCode: '47',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '47', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const svalbardAndJanMayenScaffoldProfile: ExtendedCountryProfile = {
  plugin: svalbardAndJanMayenCore,
  languages: ['no'],
  ...
  taxRegime: stubWithholding(
    'SJ-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Svalbard and Jan Mayen has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const svalbardAndJanMayenScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../sj/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
