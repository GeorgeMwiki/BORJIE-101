/**
 * Moldova, Republic of (MD) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../md/index.ts`,
...
const moldovaRepublicOfCore: CountryPlugin = {
  countryCode: 'MD',
  countryName: 'Moldova, Republic of',
  currencyCode: 'MDL',
  currencySymbol: 'L',
  phoneCountryCode: '373',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '373', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const moldovaRepublicOfScaffoldProfile: ExtendedCountryProfile = {
  plugin: moldovaRepublicOfCore,
  languages: ['ro'],
  ...
  taxRegime: stubWithholding(
    'MD-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Moldova, Republic of has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const moldovaRepublicOfScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../md/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
