/**
 * Niger (NE) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../ne/index.ts`,
...
const nigerCore: CountryPlugin = {
  countryCode: 'NE',
  countryName: 'Niger',
  currencyCode: 'XOF',
  currencySymbol: 'CFA',
  phoneCountryCode: '227',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '227', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const nigerScaffoldProfile: ExtendedCountryProfile = {
  plugin: nigerCore,
  languages: ['fr'],
  ...
  taxRegime: stubWithholding(
    'NE-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Niger has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const nigerScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../ne/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
