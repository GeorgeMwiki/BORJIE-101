/**
 * Northern Mariana Islands (MP) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../mp/index.ts`,
...
const northernMarianaIslandsCore: CountryPlugin = {
  countryCode: 'MP',
  countryName: 'Northern Mariana Islands',
  currencyCode: 'USD',
  currencySymbol: '$',
  phoneCountryCode: '1670',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '1670', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const northernMarianaIslandsScaffoldProfile: ExtendedCountryProfile = {
  plugin: northernMarianaIslandsCore,
  languages: ['en', 'ch'],
  ...
  taxRegime: stubWithholding(
    'MP-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Northern Mariana Islands has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const northernMarianaIslandsScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../mp/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
