/**
 * Lao People's Democratic Republic (LA) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../la/index.ts`,
...
const laoPeopleSDemocraticRepublicCore: CountryPlugin = {
  countryCode: 'LA',
  countryName: 'Lao People\'s Democratic Republic',
  currencyCode: 'LAK',
  currencySymbol: '₭',
  phoneCountryCode: '856',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '856', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const laoPeopleSDemocraticRepublicScaffoldProfile: ExtendedCountryProfile = {
  plugin: laoPeopleSDemocraticRepublicCore,
  languages: ['lo'],
  ...
  taxRegime: stubWithholding(
    'LA-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Lao People\'s Democratic Republic has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const laoPeopleSDemocraticRepublicScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../la/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
