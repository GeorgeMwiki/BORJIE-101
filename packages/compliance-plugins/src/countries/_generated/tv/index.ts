/**
 * Tuvalu (TV) — AUTO-GENERATED scaffold plugin.
 *
 ...
 * full-fidelity plugin, COPY this file to `../tv/index.ts`,
...
const tuvaluCore: CountryPlugin = {
  countryCode: 'TV',
  countryName: 'Tuvalu',
  currencyCode: 'AUD',
  currencySymbol: '$',
  phoneCountryCode: '688',
  normalizePhone: buildPhoneNormalizer({ dialingCode: '688', trunkPrefix: '0' }),
  kycProviders: [],
  paymentGateways: [
...
export const tuvaluScaffoldProfile: ExtendedCountryProfile = {
  plugin: tuvaluCore,
  languages: ['en'],
  ...
  taxRegime: stubWithholding(
    'TV-MANUAL-CONFIG',
    'CONFIGURE_FOR_YOUR_JURISDICTION: Tuvalu has no programmed mineral-royalty / withholding rate. Consult local mining-tax counsel and promote this scaffold (see countries/_generated/README.md).'
  ),
...
export const tuvaluScaffoldMetadata = Object.freeze({
  status: 'scaffold' as const,
  generatedAt: '2026-04-21',
  promotionGuide:
    'To replace this scaffold with full-fidelity data, copy to ../tv/index.ts and implement real royalty rates + mining-law from local sources. See _generated/README.md.',
});
